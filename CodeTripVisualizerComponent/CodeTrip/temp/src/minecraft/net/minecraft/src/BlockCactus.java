...
public class BlockCactus extends Block
{
    ...
    {
        float f = 0.0625F;
        return AxisAlignedBB.func_72332_a().func_72299_a((float)p_71911_2_ + f, p_71911_3_, (float)p_71911_4_ + f, (float)(p_71911_2_ + 1) - f, p_71911_3_ + 1, (float)(p_71911_4_ + 1) - f);
    }
