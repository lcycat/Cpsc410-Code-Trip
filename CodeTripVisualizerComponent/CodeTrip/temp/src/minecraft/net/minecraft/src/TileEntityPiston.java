...
public class TileEntityPiston extends TileEntity
{
    ...
    public float func_70337_b(float p_70337_1_)
    {
        if(field_70344_d)
        {
            return (func_70333_a(p_70337_1_) - 1.0F) * (float)Facing.field_71586_b[field_70347_c];
        } else
        {
            return (1.0F - func_70333_a(p_70337_1_)) * (float)Facing.field_71586_b[field_70347_c];
        }
    }
    ...
    public float func_70334_c(float p_70334_1_)
    {
        if(field_70344_d)
        {
            return (func_70333_a(p_70334_1_) - 1.0F) * (float)Facing.field_71587_c[field_70347_c];
        } else
        {
            return (1.0F - func_70333_a(p_70334_1_)) * (float)Facing.field_71587_c[field_70347_c];
        }
    }
    ...
    public float func_70332_d(float p_70332_1_)
    {
        if(field_70344_d)
        {
            return (func_70333_a(p_70332_1_) - 1.0F) * (float)Facing.field_71585_d[field_70347_c];
        } else
        {
            return (1.0F - func_70333_a(p_70332_1_)) * (float)Facing.field_71585_d[field_70347_c];
        }
    }
