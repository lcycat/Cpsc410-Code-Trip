...
public class Packet15Place extends Packet
{
    ...
    public Packet15Place(int p_i3366_1_, int p_i3366_2_, int p_i3366_3_, int p_i3366_4_, ItemStack p_i3366_5_, float p_i3366_6_, float p_i3366_7_, 
            float p_i3366_8_)
    {
        field_73415_a = p_i3366_1_;
        field_73413_b = p_i3366_2_;
        field_73414_c = p_i3366_3_;
        field_73411_d = p_i3366_4_;
        field_73412_e = p_i3366_5_;
        field_73409_f = p_i3366_6_;
        field_73410_g = p_i3366_7_;
        field_73416_h = p_i3366_8_;
    }
