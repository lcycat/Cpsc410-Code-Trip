...
//            BlockFluid, Vec3, NBTTagCompound, NBTTagList, 
//            NBTTagDouble, NBTTagFloat, EntityList, ItemStack, 
//            EntityItem, StatCollector, WorldInfo, EntityLightningBolt
...
public abstract class Entity
{
    ...
    {
        float f = field_70125_A;
        float f1 = field_70177_z;
        field_70177_z += (double)p_70082_1_ * 0.14999999999999999D;
        field_70125_A -= (double)p_70082_2_ * 0.14999999999999999D;
        if(field_70125_A < -90F)
        {
            field_70125_A = -90F;
        }
        if(field_70125_A > 90F)
        ...
        field_70127_C += field_70125_A - f;
        field_70126_B += field_70177_z - f1;
    }
    ...
    public int func_70070_b(float p_70070_1_)
    {
        ...
        if(field_70170_p.func_72899_e(i, 0, j))
        {
            ...
            return field_70170_p.func_72802_i(i, k, j, 0);
        } else
        {
            return 0;
        }
    ...
    {
        double d = field_70165_t - p_70102_1_.field_72450_a;
        double d1 = field_70163_u - p_70102_1_.field_72448_b;
        double d2 = field_70161_v - p_70102_1_.field_72449_c;
        double d3 = d * d + d1 * d1 + d2 * d2;
        return func_70112_a(d3);
    }

    public boolean func_70112_a(double p_70112_1_)
    {
        double d = field_70121_D.func_72320_b();
        d *= 64D * field_70155_l;
            ...
            float p_70056_8_, int p_70056_9_)
    {
        ...
        List list = field_70170_p.func_72945_a(this, field_70121_D.func_72331_e(0.03125D, 0.0D, 0.03125D));
        if(!list.isEmpty())
        {
            double d = 0.0D;
            ...
            p_70056_3_ += d - field_70121_D.field_72338_b;
            func_70107_b(p_70056_1_, p_70056_3_, p_70056_5_);
        }
    }
    ...
    {
        return field_70154_o != null || func_70083_f(2);
    }
