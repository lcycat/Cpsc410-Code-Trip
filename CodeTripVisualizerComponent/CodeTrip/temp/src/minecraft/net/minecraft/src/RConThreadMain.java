...
public class RConThreadMain extends RConThreadBase
{
    ...
    public RConThreadMain(IServer p_i3408_1_)
    {
        super(p_i3408_1_);
        field_72649_j = null;
        field_72647_g = p_i3408_1_.func_71327_a("rcon.port", 0);
        field_72650_k = p_i3408_1_.func_71330_a("rcon.password", "");
        field_72652_i = p_i3408_1_.func_71277_t();
        field_72651_h = p_i3408_1_.func_71234_u();
        if(0 == field_72647_g)
        {
            ...
            p_i3408_1_.func_71328_a("rcon.port", Integer.valueOf(field_72647_g));
