...
public class BlockLever extends Block
{
    ...
    {
        if(p_71850_5_ == 0 && p_71850_1_.func_72809_s(p_71850_2_, p_71850_3_ + 1, p_71850_4_))
        {
            return true;
        }
        if(p_71850_5_ == 1 && p_71850_1_.func_72797_t(p_71850_2_, p_71850_3_ - 1, p_71850_4_))
        {
            return true;
        }
    ...
    public boolean func_71930_b(World p_71930_1_, int p_71930_2_, int p_71930_3_, int p_71930_4_)
    {
        ...
        return p_71930_1_.func_72809_s(p_71930_2_, p_71930_3_ + 1, p_71930_4_);
    }
            ...
            float p_71909_8_)
    {
        ...
        {
            i = p_71909_1_.field_73012_v.nextBoolean() ? 0 : 7;
        }
        if(p_71909_5_ == 1 && p_71909_1_.func_72797_t(p_71909_2_, p_71909_3_ - 1, p_71909_4_))
        {
            i = 5 + p_71909_1_.field_73012_v.nextInt(2);
        }
        ...
        if(i == -1)
        {
            func_71897_c(p_71909_1_, p_71909_2_, p_71909_3_, p_71909_4_, p_71909_1_.func_72805_g(p_71909_2_, p_71909_3_, p_71909_4_), 0);
    ...
    {
        if(func_72195_l(p_71863_1_, p_71863_2_, p_71863_3_, p_71863_4_))
        {
            ...
            if(!p_71863_1_.func_72797_t(p_71863_2_, p_71863_3_ - 1, p_71863_4_) && i == 5)
            {
                flag = true;
            }
            if(!p_71863_1_.func_72797_t(p_71863_2_, p_71863_3_ - 1, p_71863_4_) && i == 6)
            {
                flag = true;
            }
            if(!p_71863_1_.func_72809_s(p_71863_2_, p_71863_3_ + 1, p_71863_4_) && i == 0)
            {
                flag = true;
            }
            if(!p_71863_1_.func_72809_s(p_71863_2_, p_71863_3_ + 1, p_71863_4_) && i == 7)
            {
                flag = true;
            }
            if(flag)
    ...
    {
        if(!func_71930_b(p_72195_1_, p_72195_2_, p_72195_3_, p_72195_4_))
        {
            func_71897_c(p_72195_1_, p_72195_2_, p_72195_3_, p_72195_4_, p_72195_1_.func_72805_g(p_72195_2_, p_72195_3_, p_72195_4_), 0);
    ...
    public void func_71902_a(IBlockAccess p_71902_1_, int p_71902_2_, int p_71902_3_, int p_71902_4_)
    {
        ...
        {
            float f2 = 0.25F;
            func_71905_a(0.5F - f2, 0.4F, 0.5F - f2, 0.5F + f2, 1.0F, 0.5F + f2);
        }
    }
            ...
            float p_71903_8_, float p_71903_9_)
    {
        ...
        p_71903_1_.func_72908_a((double)p_71903_2_ + 0.5D, (double)p_71903_3_ + 0.5D, (double)p_71903_4_ + 0.5D, "random.click", 0.3F, k <= 0 ? 0.5F : 0.6F);
