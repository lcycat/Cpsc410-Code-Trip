...
public abstract class EntityLiving extends Entity
{
    ...
    {
        field_70129_M = 0.0F;
        field_70709_bj = p_70056_1_;
        field_70710_bk = p_70056_3_;
        field_70711_bl = p_70056_5_;
        field_70712_bm = p_70056_7_;
        field_70705_bn = p_70056_8_;
        field_70716_bi = p_70056_9_;
    }
    ...
    {
        float f = field_70733_aJ - field_70732_aI;
        if(f < 0.0F)
        {
            f++;
        }
        return field_70732_aI + f * p_70678_1_;
    }
    ...
    public Vec3 func_70666_h(float p_70666_1_)
    {
        if(p_70666_1_ == 1.0F)
        {
            return Vec3.func_72437_a().func_72345_a(field_70165_t, field_70163_u, field_70161_v);
        } else
        {
            double d = field_70169_q + (field_70165_t - field_70169_q) * (double)p_70666_1_;
            double d1 = field_70167_r + (field_70163_u - field_70167_r) * (double)p_70666_1_;
            double d2 = field_70166_s + (field_70161_v - field_70166_s) * (double)p_70666_1_;
    ...
    {
        Vec3 vec3 = func_70666_h(p_70614_3_);
        Vec3 vec3_1 = func_70676_i(p_70614_3_);
        Vec3 vec3_2 = vec3.func_72441_c(vec3_1.field_72450_a * p_70614_1_, vec3_1.field_72448_b * p_70614_1_, vec3_1.field_72449_c * p_70614_1_);
        return field_70170_p.func_72933_a(vec3, vec3_2);
    }
    ...
    public void func_70103_a(byte p_70103_1_)
    {
        if(p_70103_1_ == 2)
        {
            ...
            field_70737_aN = field_70738_aO = 10;
            field_70739_aP = 0.0F;
            field_70170_p.func_72956_a(this, func_70621_aR(), func_70599_aP(), (field_70146_Z.nextFloat() - field_70146_Z.nextFloat()) * 0.2F + 1.0F);
            func_70097_a(DamageSource.field_76377_j, 0);
        } else
        if(p_70103_1_ == 3)
        {
            field_70170_p.func_72956_a(this, func_70673_aS(), func_70599_aP(), (field_70146_Z.nextFloat() - field_70146_Z.nextFloat()) * 0.2F + 1.0F);
            field_70734_aK = 0;
    ...
    {
        field_70713_bf.remove(Integer.valueOf(p_70618_1_));
    }
