...
public class Block
{
    ...
    {
        if(p_71877_5_ == 0 && field_72023_ci > 0.0D)
        {
            return true;
        }
        if(p_71877_5_ == 1 && field_72022_cl < 1.0D)
        {
            return true;
        }
        if(p_71877_5_ == 2 && field_72024_cj > 0.0D)
        {
            return true;
        }
        if(p_71877_5_ == 3 && field_72019_cm < 1.0D)
        {
            return true;
        }
        if(p_71877_5_ == 4 && field_72026_ch > 0.0D)
        {
            return true;
        }
        if(p_71877_5_ == 5 && field_72021_ck < 1.0D)
        {
            return true;
        } else
        {
            return !p_71877_1_.func_72804_r(p_71877_2_, p_71877_3_, p_71877_4_);
        }
    }
    ...
    {
        return func_71858_a(p_71895_5_, p_71895_1_.func_72805_g(p_71895_2_, p_71895_3_, p_71895_4_));
    }
    ...
    {
        return AxisAlignedBB.func_72332_a().func_72299_a((double)p_71911_2_ + field_72026_ch, (double)p_71911_3_ + field_72023_ci, (double)p_71911_4_ + field_72024_cj, (double)p_71911_2_ + field_72021_ck, (double)p_71911_3_ + field_72022_cl, (double)p_71911_4_ + field_72019_cm);
    }
    ...
    {
        return func_71899_b(p_71873_1_.func_72805_g(p_71873_2_, p_71873_3_, p_71873_4_));
    }
