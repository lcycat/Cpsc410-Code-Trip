...
public class MapCoord
{
    ...
    final MapData field_76213_e; /* synthetic field */

    public MapCoord(MapData p_i3905_1_, byte p_i3905_2_, byte p_i3905_3_, byte p_i3905_4_, byte p_i3905_5_)
    {
        field_76213_e = p_i3905_1_;
        super();
        field_76216_a = p_i3905_2_;
        field_76214_b = p_i3905_3_;
        field_76215_c = p_i3905_4_;
        field_76212_d = p_i3905_5_;
    }
}
