...
//            CrashReport, CanvasMojangLogo, CanvasCrashReport
...
public class PanelCrashReport extends Panel
{
    ...
    public PanelCrashReport(CrashReport p_i3010_1_)
    {
        ...
        p_i3010_1_.func_71505_b().printStackTrace(new PrintWriter(stringwriter));
        ...
        try
        {
            ...
            s2 = (new StringBuilder()).append(s2).append(p_i3010_1_.func_71509_c()).toString();
        ...
        } else
        {
            ...
            s3 = (new StringBuilder()).append(s3).append("      ----------------------      \n").toString();
            s3 = (new StringBuilder()).append(s3).append("\n").toString();
            s3 = (new StringBuilder()).append(s3).append("Minecraft has stopped running because it encountered a problem; ").append(p_i3010_1_.func_71501_a()).append("\n").toString();
            File file = p_i3010_1_.func_71497_f();
            if(file == null)
            {
                p_i3010_1_.func_71508_a(new File(new File(Minecraft.func_71380_b(), "crash-reports"), (new StringBuilder()).append("crash-").append((new SimpleDateFormat("yyyy-MM-dd_HH.mm.ss")).format(new Date())).append("-client.txt").toString()));
                file = p_i3010_1_.func_71497_f();
            }
            if(file != null)
            {
