...
public class WorldType
{
    ...
    {
        return this != field_77137_b || p_77132_1_ != 0 ? this : field_77136_e;
    }
    ...
    {
        return ((WorldChunkManager) (this != field_77138_c ? new WorldChunkManager(world) : new WorldChunkManagerHell(BiomeGenBase.field_76772_c, 0.5F, 0.5F)));
    }

    public IChunkProvider getChunkGenerator(World world)
    {
        return ((IChunkProvider) (this != field_77138_c ? new ChunkProviderGenerate(world, world.func_72905_C(), world.func_72912_H().func_76089_r()) : new ChunkProviderFlat(world, world.func_72905_C(), world.func_72912_H().func_76089_r())));
    }
