...
public class ComponentNetherBridgeCorridor2 extends ComponentNetherBridgePiece
{
    ...
    {
        super(p_i3823_1_);
        field_74885_f = p_i3823_4_;
        field_74887_e = p_i3823_3_;
    }
    ...
    public static ComponentNetherBridgeCorridor2 func_74980_a(List p_74980_0_, Random p_74980_1_, int p_74980_2_, int p_74980_3_, int p_74980_4_, int p_74980_5_, int p_74980_6_)
    {
        ...
        if(!func_74964_a(structureboundingbox) || StructureComponent.func_74883_a(p_74980_0_, structureboundingbox) != null)
        {
            return null;
        } else
        {
            return new ComponentNetherBridgeCorridor2(p_74980_6_, p_74980_1_, structureboundingbox, p_74980_5_);
        }
    }
    ...
    public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_)
    {
        ...
        func_74884_a(p_74875_1_, p_74875_3_, 1, 2, 4, 4, 5, 4, Block.field_72033_bA.field_71990_ca, Block.field_72033_bA.field_71990_ca, false);
