...
//            BouncyCastleProviderAction, BouncyCastleProviderConfiguration
    ...
    implements ConfigurableProvider
{
    ...
    {
        for(int i = 0; i != p_74819_2_.length; i++)
        {
            Class class1 = null;
            try
            {
                ...
                if(classloader != null)
                {
                    class1 = classloader.loadClass((new StringBuilder()).append(p_74819_1_).append(p_74819_2_[i]).append("$Mappings").toString());
                } else
                {
                    class1 = Class.forName((new StringBuilder()).append(p_74819_1_).append(p_74819_2_[i]).append("$Mappings").toString());
                }
            }
            ...
            catch(Exception exception)
            {
                ...
                throw new InternalError((new StringBuilder()).append("cannot create instance of ").append(p_74819_1_).append(p_74819_2_[i]).append("$Mappings : ").append(exception).toString());
            }
        }
