...
public class RConThreadQuery extends RConThreadBase
{
    ...
    public RConThreadQuery(IServer par1IServer)
    {
        ...
        worldName = par1IServer.func_71270_I();
    ...
    {
        return ((RConThreadQueryAuth)field_72641_s.get(par1SocketAddress)).getRequestID();
    }
    ...
    private Boolean verifyClientAuth(DatagramPacket par1DatagramPacket)
    {
        ...
        if (((RConThreadQueryAuth)field_72641_s.get(socketaddress)).getRandomChallenge() != RConUtils.getBytesAsBEint(abyte0, 7, par1DatagramPacket.getLength()))
        {
            return Boolean.valueOf(false);
        }
        else
