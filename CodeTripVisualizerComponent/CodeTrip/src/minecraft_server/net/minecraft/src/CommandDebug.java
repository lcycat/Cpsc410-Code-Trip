...
public class CommandDebug extends CommandBase
{
    ...
    public void processCommand(ICommandSender par1ICommandSender, String par2ArrayOfStr[])
    {
        if (par2ArrayOfStr.length == 1)
        {
            if (par2ArrayOfStr[0].equals("start"))
            {
                ...
                field_71550_b = MinecraftServer.getServer().func_71259_af();
                return;
            }
            ...
            if (par2ArrayOfStr[0].equals("stop"))
            {
                ...
                else
                {
                    ...
                    int i = MinecraftServer.getServer().func_71259_af();
    ...
    {
        File file = new File(MinecraftServer.getServer().getFile("debug"), (new StringBuilder()).append("profile-results-").append((new SimpleDateFormat("yyyy-MM-dd_HH.mm.ss")).format(new Date())).append(".txt").toString());
    ...
    {
        List list = MinecraftServer.getServer().field_71304_b.func_76321_b(par2Str);
