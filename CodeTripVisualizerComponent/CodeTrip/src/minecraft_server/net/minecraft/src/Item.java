...
public class Item
{
     ...
     */
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int i, int j, int k, int l, float f, float f1, float f2)
    {
        return false;
    }
    ...
    static
    {
        ...
        diamond = (new Item(8)).setIconCoord(7, 3).setItemName("diamond").func_77637_a(CreativeTabs.field_78035_l);
        ...
        writableBook = (new ItemWritableBook(130)).setIconCoord(11, 11).setItemName("writingBook").func_77637_a(CreativeTabs.field_78026_f);
        emerald = (new Item(132)).setIconCoord(10, 11).setItemName("emerald").func_77637_a(CreativeTabs.field_78035_l);
        StatList.initStats();
    }
}
