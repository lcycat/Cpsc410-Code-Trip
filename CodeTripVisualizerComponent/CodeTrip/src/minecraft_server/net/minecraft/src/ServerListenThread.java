    ...
    public void run()
    {
        do
        {
            ...
            try
            {
                ...
                NetLoginHandler netloginhandler = new NetLoginHandler(field_71771_f.getServer(), socket, (new StringBuilder()).append("Connection #").append(field_71773_d++).toString());
