        ...
        if (!worldObj.isRemote)
        {
            ...
            if (onGround)
            {
                ...
                if (worldObj.getBlockId(i, j, k) != Block.pistonMoving.blockID)
                {
                    ...
                    if ((!worldObj.func_72931_a(blockID, i, j, k, true, 1, null) || BlockSand.canFallBelow(worldObj, i, j - 1, k) || !worldObj.setBlockAndMetadataWithNotify(i, j, k, blockID, field_70285_b)) && !worldObj.isRemote && field_70284_d)
                    {
