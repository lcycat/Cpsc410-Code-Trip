...
public class ComponentScatteredFeatureDesertPyramid extends ComponentScatteredFeature
{
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        int k = getMetadataWithOffset(Block.field_72088_bQ.blockID, 3);
        int i1 = getMetadataWithOffset(Block.field_72088_bQ.blockID, 2);
        int j1 = getMetadataWithOffset(Block.field_72088_bQ.blockID, 0);
        int k1 = getMetadataWithOffset(Block.field_72088_bQ.blockID, 1);
        int l1 = 1;
        byte byte0 = 11;
        ...
        placeBlockAtCurrentPosition(par1World, Block.field_72088_bQ.blockID, k, 2, 10, 0, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_72088_bQ.blockID, i1, 2, 10, 4, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_72088_bQ.blockID, j1, 0, 10, 2, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_72088_bQ.blockID, k1, 4, 10, 2, par3StructureBoundingBox);
        ...
        placeBlockAtCurrentPosition(par1World, Block.field_72088_bQ.blockID, k, field_74939_a - 3, 10, 0, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_72088_bQ.blockID, i1, field_74939_a - 3, 10, 4, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_72088_bQ.blockID, j1, field_74939_a - 5, 10, 2, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_72088_bQ.blockID, k1, field_74939_a - 1, 10, 2, par3StructureBoundingBox);
        ...
        placeBlockAtCurrentPosition(par1World, Block.field_72088_bQ.blockID, k, 2, 4, 5, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_72088_bQ.blockID, k, 2, 3, 4, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_72088_bQ.blockID, k, field_74939_a - 3, 4, 5, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_72088_bQ.blockID, k, field_74939_a - 3, 3, 4, par3StructureBoundingBox);
        ...
        placeBlockAtCurrentPosition(par1World, Block.field_72088_bQ.blockID, 0, 1, 1, 2, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_72088_bQ.blockID, 0, field_74939_a - 2, 1, 2, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.stoneSingleSlab.blockID, 1, 1, 2, 2, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.stoneSingleSlab.blockID, 1, field_74939_a - 2, 2, 2, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_72088_bQ.blockID, k1, 2, 1, 2, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_72088_bQ.blockID, j1, field_74939_a - 3, 1, 2, par3StructureBoundingBox);
