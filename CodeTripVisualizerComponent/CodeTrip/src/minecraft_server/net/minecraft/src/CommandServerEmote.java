...
public class CommandServerEmote extends CommandBase
{
    ...
    public void processCommand(ICommandSender par1ICommandSender, String par2ArrayOfStr[])
    {
        if (par2ArrayOfStr.length > 0)
        {
            ...
            MinecraftServer.getServer().func_71203_ab().sendPacketToAllPlayers(new Packet3Chat((new StringBuilder()).append("* ").append(par1ICommandSender.getCommandSenderName()).append(" ").append(s).toString()));
            return;
        }
        else
        {
