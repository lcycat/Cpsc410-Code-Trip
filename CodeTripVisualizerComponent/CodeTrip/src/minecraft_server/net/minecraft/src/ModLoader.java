...
public final class ModLoader
{
    ...
    private static void init()
    {
        ...
        try
        {
            ...
            MinecraftServer.logger.info("ModLoaderMP 1.3.1v1 Initializing...");
    ...
    {
        minecraftserver.field_71304_b.endSection();
        minecraftserver.field_71304_b.endSection();
        minecraftserver.field_71304_b.startSection("modtick");
        ...
        clock = l;
        minecraftserver.field_71304_b.endSection();
        minecraftserver.field_71304_b.startSection("render");
        minecraftserver.field_71304_b.startSection("gameRenderer");
    }
    ...
    public static void serverOpenWindow(EntityPlayerMP entityplayermp, Container container, int i, int j, int k, int l)
    {
        try
        {
            ...
            entityplayermp.playerNetServerHandler.sendPacket(new Packet250CustomPayload("ML|OpenTE", bytearrayoutputstream.toByteArray()));
            entityplayermp.craftingInventory = container;
