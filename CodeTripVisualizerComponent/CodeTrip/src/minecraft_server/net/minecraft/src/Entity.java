...
public abstract class Entity
{
    ...
    public String toString()
    {
        return String.format("%s['%s'/%d, l='%s', x=%.2f, y=%.2f, z=%.2f]", new Object[]
                {
                    getClass().getSimpleName(), getEntityName(), Integer.valueOf(entityId), worldObj != null ? worldObj.getWorldInfo().func_76065_j() : "~NULL~", Double.valueOf(posX), Double.valueOf(posY), Double.valueOf(posZ)
                });
    }
}
