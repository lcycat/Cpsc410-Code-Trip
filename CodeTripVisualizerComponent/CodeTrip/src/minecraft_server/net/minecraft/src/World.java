...
public abstract class World implements IBlockAccess
{
    ...
    {
        par1CrashReport.addCrashSectionCallable((new StringBuilder()).append("World ").append(worldInfo.func_76065_j()).append(" Entities").toString(), new CallableLvl1(this));
        par1CrashReport.addCrashSectionCallable((new StringBuilder()).append("World ").append(worldInfo.func_76065_j()).append(" Players").toString(), new CallableLvl2(this));
        par1CrashReport.addCrashSectionCallable((new StringBuilder()).append("World ").append(worldInfo.func_76065_j()).append(" Chunk Stats").toString(), new CallableLvl3(this));
