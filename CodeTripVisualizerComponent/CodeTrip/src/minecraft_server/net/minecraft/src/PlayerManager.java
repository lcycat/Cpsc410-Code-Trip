...
public class PlayerManager
{
    ...
    public void updatePlayerInstances()
    {
        ...
        if (players.isEmpty())
        {
            WorldProvider worldprovider = field_72701_a.provider;

            if (!worldprovider.canRespawnHere())
            {
                field_72701_a.theChunkProviderServer.unloadAllChunks();
            }
        }
    }
    ...
    public void func_72691_b(EntityPlayerMP par1EntityPlayerMP)
    {
        ...
        int i1 = 0;
        int j1 = 0;
        ChunkCoordIntPair chunkcoordintpair = PlayerInstance.func_73253_a(getPlayerInstance(k, l, true));
        ...
        for (int k1 = 1; k1 <= j * 2; k1++)
        {
            for (int i2 = 0; i2 < 2; i2++)
            {
                ...
                for (int j2 = 0; j2 < k1; j2++)
                {
                    i1 += ai[0];
                    j1 += ai[1];
                    ChunkCoordIntPair chunkcoordintpair1 = PlayerInstance.func_73253_a(getPlayerInstance(k + i1, l + j1, true));
        ...
        for (int l1 = 0; l1 < j * 2; l1++)
        {
            ...
            ChunkCoordIntPair chunkcoordintpair2 = PlayerInstance.func_73253_a(getPlayerInstance(k + i1, l + j1, true));
    ...
    {
        PlayerInstance playerinstance = getPlayerInstance(par2, par3, false);
