...
class GuiSlotServer extends GuiSlot
{
    ...
    private void func_77247_d(int par1, int par2, int par3, int par4, Tessellator par5Tessellator)
    {
        ...
        parentGui.drawString(parentGui.fontRenderer, serverdata.serverName, par2 + 2, par3 + 1, 0xffffff);
        ...
        parentGui.drawString(parentGui.fontRenderer, serverdata.serverIP, par2 + 2, par3 + 12 + 11, 0x303030);
        ...
        {
            i = 1;
            j = (int)(Minecraft.getSystemTime() / 100L + (long)(par1 * 2) & 7L);
