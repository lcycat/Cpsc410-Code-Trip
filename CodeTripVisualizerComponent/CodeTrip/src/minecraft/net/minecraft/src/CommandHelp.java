...
public class CommandHelp extends CommandBase
{
    ...
    public void processCommand(ICommandSender par1ICommandSender, String par2ArrayOfStr[])
    {
        ...
        par1ICommandSender.sendChatToPlayer((new StringBuilder()).append("\2472").append(par1ICommandSender.translateString("commands.help.header", new Object[]
                {
        ...
        if (j == 0)
        {
            par1ICommandSender.sendChatToPlayer((new StringBuilder()).append("\247a").append(par1ICommandSender.translateString("commands.help.footer", new Object[0])).toString());
        }
    }
