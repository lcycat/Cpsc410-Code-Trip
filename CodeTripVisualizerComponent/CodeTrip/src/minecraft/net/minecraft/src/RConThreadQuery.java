...
public class RConThreadQuery extends RConThreadBase
{
    ...
    public RConThreadQuery(IServer par1IServer)
    {
        ...
        field_72631_o = null;
        field_72636_h = par1IServer.getOrSetIntProperty("query.port", 0);
        field_72642_r = par1IServer.getHostName();
        field_72637_i = par1IServer.getMyServerPort();
        field_72635_k = par1IServer.getServerMOTD();
        field_72634_j = par1IServer.getMaxPlayers();
        field_72632_l = par1IServer.getFolderName();
        field_72638_v = 0L;
        ...
        if (0 == field_72642_r.length() || field_72643_q.equals(field_72642_r))
        {
            ...
            {
                func_72606_c((new StringBuilder()).append("Unable to determine local host IP, please set server-ip in '").append(par1IServer.getSettingsFilePath()).append("' : ").append(unknownhostexception.getMessage()).toString());
            }
        }
        else
        {
        ...
        if (0 == field_72636_h)
        {
            ...
            par1IServer.setArbitraryProperty("query.port", Integer.valueOf(field_72636_h));
    ...
    private byte[] func_72624_b(DatagramPacket par1DatagramPacket) throws IOException
    {
        ...
        field_72639_u.func_72671_a(field_72617_b.getMinecraftVersion());
        field_72639_u.func_72671_a("plugins");
        field_72639_u.func_72671_a(field_72617_b.returnAnEmptyString());
        ...
        field_72639_u.func_72667_a(0);
        String as[] = field_72617_b.getAllUsernames();
    ...
    public void func_72602_a()
    {
        ...
        {
            func_72606_c((new StringBuilder()).append("Invalid query port ").append(field_72636_h).append(" found in '").append(field_72617_b.getSettingsFilePath()).append("' (queries disabled)").toString());
            return;
        }
