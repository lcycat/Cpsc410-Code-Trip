...
public class WorldClient extends World
{
    ...
    public void playSound(double par1, double par3, double par5, String par7Str, float par8, float par9)
    {
        ...
        if (minecraftInstance.renderViewEntity.getDistanceSq(par1, par3, par5) < (double)(f * f))
        {
            minecraftInstance.sndManager.playSound(par7Str, (float)par1, (float)par3, (float)par5, par8, par9);
        }
    }
