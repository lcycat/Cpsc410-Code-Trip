...
public class SlotMerchantResult extends Slot
{
    ...
    {
        onCrafting(par1ItemStack);
        MerchantRecipe merchantrecipe = field_75233_a.getCurrentRecipe();
        ...
        if (merchantrecipe != null)
        {
            ...
            if (func_75230_a(merchantrecipe, itemstack, itemstack1) || func_75230_a(merchantrecipe, itemstack1, itemstack))
            {
                ...
                field_75234_h.useRecipe(merchantrecipe);
            }
        }
    }
    ...
    {
        ItemStack itemstack = par1MerchantRecipe.getItemToBuy();
        ItemStack itemstack1 = par1MerchantRecipe.getSecondItemToBuy();
