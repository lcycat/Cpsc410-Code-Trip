...
public class Packet252SharedKey extends Packet
{
    ...
    {
        field_73307_a = readBytesFromStream(par1DataInputStream);
        field_73305_b = readBytesFromStream(par1DataInputStream);
    }
    ...
    {
        writeByteArray(par1DataOutputStream, field_73307_a);
        writeByteArray(par1DataOutputStream, field_73305_b);
    }
