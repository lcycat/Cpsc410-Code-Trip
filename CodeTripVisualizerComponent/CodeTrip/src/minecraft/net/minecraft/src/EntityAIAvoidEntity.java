...
public class EntityAIAvoidEntity extends EntityAIBase
{
    ...
    public boolean shouldExecute()
    {
        ...
        Vec3 vec3 = RandomPositionGenerator.findRandomTargetBlockAwayFrom(theEntity, 16, 7, Vec3.getVec3Pool().getVecFromPool(closestLivingEntity.posX, closestLivingEntity.posY, closestLivingEntity.posZ));
    ...
    {
        entityPathNavigate.setPath(field_75374_f, farSpeed);
    }
