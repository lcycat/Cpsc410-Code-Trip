...
final class ConsoleLogFormatter extends Formatter
{
    ...
    private SimpleDateFormat simpleDateFormatLogFormatter;

    ConsoleLogFormatter()
    {
        simpleDateFormatLogFormatter = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    }

    public String format(LogRecord par1LogRecord)
    {
        StringBuilder stringbuilder = new StringBuilder();
        stringbuilder.append(simpleDateFormatLogFormatter.format(Long.valueOf(par1LogRecord.getMillis())));
