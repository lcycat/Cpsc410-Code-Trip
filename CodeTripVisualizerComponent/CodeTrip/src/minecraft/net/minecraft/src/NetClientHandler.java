...
public class NetClientHandler extends NetHandler
{
    ...
    public void handleVehicleSpawn(Packet23VehicleSpawn par1Packet23VehicleSpawn)
    {
            ...
            try
            {
                ...
                if (netclienthandlerentity.entityHasOwner)
                {
                    ...
                    if ((net.minecraft.src.Entity.class).isAssignableFrom(field.getType()))
                    {
                        ...
                        else if (field.getType().isAssignableFrom(entity1.getClass()))
                        {
        ...
        if (obj != null)
        {
            ...
            if (par1Packet23VehicleSpawn.throwerEntityId > 0)
            {
                ...
                {
                    Entity entity2 = getEntityByID(par1Packet23VehicleSpawn.throwerEntityId);
    ...
    public void handleOpenWindow(Packet100OpenWindow par1Packet100OpenWindow)
    {
        ...
        switch (par1Packet100OpenWindow.inventoryType)
        {
            case 0:
                ...
                entityclientplayermp.craftingInventory.windowId = par1Packet100OpenWindow.windowId;
                break;
            ...
            case 4:
                entityclientplayermp.displayGUIEnchantment(MathHelper.floor_double(entityclientplayermp.posX), MathHelper.floor_double(entityclientplayermp.posY), MathHelper.floor_double(entityclientplayermp.posZ));
                entityclientplayermp.craftingInventory.windowId = par1Packet100OpenWindow.windowId;
                break;
    ...
    public void handleSetSlot(Packet103SetSlot par1Packet103SetSlot)
    {
        ...
        else
        {
            ...
            {
                ItemStack itemstack = entityclientplayermp.inventorySlots.getSlot(par1Packet103SetSlot.itemSlot).getStack();
                ...
                entityclientplayermp.inventorySlots.putStackInSlot(par1Packet103SetSlot.itemSlot, par1Packet103SetSlot.myItemStack);
            }
            else if (par1Packet103SetSlot.windowId == entityclientplayermp.craftingInventory.windowId && (par1Packet103SetSlot.windowId != 0 || !flag))
            {
                entityclientplayermp.craftingInventory.putStackInSlot(par1Packet103SetSlot.itemSlot, par1Packet103SetSlot.myItemStack);
            }
        }
    }
    ...
    public void handleTransaction(Packet106Transaction par1Packet106Transaction)
    {
        ...
        {
            container = entityclientplayermp.inventorySlots;
        }
        else if (par1Packet106Transaction.windowId == entityclientplayermp.craftingInventory.windowId)
        {
            container = entityclientplayermp.craftingInventory;
        }
    ...
    public void handleWindowItems(Packet104WindowItems par1Packet104WindowItems)
    {
        ...
        {
            entityclientplayermp.inventorySlots.putStacksInSlots(par1Packet104WindowItems.itemStack);
        }
        else if (par1Packet104WindowItems.windowId == entityclientplayermp.craftingInventory.windowId)
        {
            entityclientplayermp.craftingInventory.putStacksInSlots(par1Packet104WindowItems.itemStack);
        }
    }
    ...
    public void handleUpdateProgressbar(Packet105UpdateProgressbar par1Packet105UpdateProgressbar)
    {
        ...
        if (entityclientplayermp.craftingInventory != null && entityclientplayermp.craftingInventory.windowId == par1Packet105UpdateProgressbar.windowId)
        {
            entityclientplayermp.craftingInventory.updateProgressBar(par1Packet105UpdateProgressbar.progressBar, par1Packet105UpdateProgressbar.progressBarValue);
        }
    }
    ...
    {
        EntityClientPlayerMP entityclientplayermp = mc.thePlayer;
        entityclientplayermp.capabilities.isFlying = par1Packet202PlayerAbilities.getIsFlying();
