...
public class ServerList
{
    ...
    public void func_78853_a()
    {
        try
        {
            ...
            {
                field_78858_b.add(ServerData.getServerDataFromNBTCompound((NBTTagCompound)nbttaglist.tagAt(i)));
            }
        }
    ...
    public static void func_78852_b(ServerData par0ServerData)
    {
        ...
        do
        {
            ...
            if (serverdata.serverName.equals(par0ServerData.serverName) && serverdata.serverIP.equals(par0ServerData.serverIP))
            {
