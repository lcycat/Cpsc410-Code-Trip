...
public class RenderBlocks
{
    ...
    public boolean renderBlockByRenderType(Block par1Block, int par2, int par3, int par4)
    {
        ...
        {
            return ModLoader.renderWorldBlock(this, blockAccess, par2, par3, par4, par1Block, i);
        }
    }
    ...
    public boolean func_78577_f(Block par1Block, int par2, int par3, int par4)
    {
        ...
        float f11 = 0.046875F;
        float f12 = 0.3125F;
        avec3[0] = Vec3.getVec3Pool().getVecFromPool(-f10, 0.0D, -f11);
        avec3[1] = Vec3.getVec3Pool().getVecFromPool(f10, 0.0D, -f11);
        avec3[2] = Vec3.getVec3Pool().getVecFromPool(f10, 0.0D, f11);
        avec3[3] = Vec3.getVec3Pool().getVecFromPool(-f10, 0.0D, f11);
        avec3[4] = Vec3.getVec3Pool().getVecFromPool(-f10, f12, -f11);
        avec3[5] = Vec3.getVec3Pool().getVecFromPool(f10, f12, -f11);
        avec3[6] = Vec3.getVec3Pool().getVecFromPool(f10, f12, f11);
        avec3[7] = Vec3.getVec3Pool().getVecFromPool(-f10, f12, f11);
        ...
        for (int k1 = 0; k1 < 6; k1++)
        {
            ...
            tessellator.addVertexWithUV(vec3.xCoord, vec3.yCoord, vec3.zCoord, f6, f9);
            tessellator.addVertexWithUV(vec3_1.xCoord, vec3_1.yCoord, vec3_1.zCoord, f7, f9);
            tessellator.addVertexWithUV(vec3_2.xCoord, vec3_2.yCoord, vec3_2.zCoord, f7, f8);
            tessellator.addVertexWithUV(vec3_3.xCoord, vec3_3.yCoord, vec3_3.zCoord, f6, f8);
        }

        float f13 = 0.09375F;
        float f14 = 0.09375F;
        float f15 = 0.03125F;
        avec3[0] = Vec3.getVec3Pool().getVecFromPool(-f13, 0.0D, -f14);
        avec3[1] = Vec3.getVec3Pool().getVecFromPool(f13, 0.0D, -f14);
        avec3[2] = Vec3.getVec3Pool().getVecFromPool(f13, 0.0D, f14);
        avec3[3] = Vec3.getVec3Pool().getVecFromPool(-f13, 0.0D, f14);
        avec3[4] = Vec3.getVec3Pool().getVecFromPool(-f13, f15, -f14);
        avec3[5] = Vec3.getVec3Pool().getVecFromPool(f13, f15, -f14);
        avec3[6] = Vec3.getVec3Pool().getVecFromPool(f13, f15, f14);
        avec3[7] = Vec3.getVec3Pool().getVecFromPool(-f13, f15, f14);
        ...
        if (flag)
        {
            ...
            float f19 = par1Block.getBlockBrightness(blockAccess, par2, par3, par4) * 0.75F;
            tessellator.setColorOpaque_F(f19, f19, f19);

            if (j == 2)
            {
                tessellator.addVertexWithUV((float)par2 + f17, (double)par3 + d5, (double)par4 + 0.25D, d1, d3);
                tessellator.addVertexWithUV((float)par2 + f18, (double)par3 + d5, (double)par4 + 0.25D, d1, d4);
                tessellator.addVertexWithUV((float)par2 + f18, (double)par3 + d5, par4, d2, d4);
                tessellator.addVertexWithUV((float)par2 + f17, (double)par3 + d5, par4, d2, d3);
                tessellator.addVertexWithUV((float)par2 + f17, d, (double)par4 + 0.5D, d1, d3);
                tessellator.addVertexWithUV((float)par2 + f18, d, (double)par4 + 0.5D, d1, d4);
                tessellator.addVertexWithUV((float)par2 + f18, (double)par3 + d5, (double)par4 + 0.25D, d2, d4);
                tessellator.addVertexWithUV((float)par2 + f17, (double)par3 + d5, (double)par4 + 0.25D, d2, d3);
            }
            else if (j == 0)
            {
                tessellator.addVertexWithUV((float)par2 + f17, (double)par3 + d5, (double)par4 + 0.75D, d1, d3);
                tessellator.addVertexWithUV((float)par2 + f18, (double)par3 + d5, (double)par4 + 0.75D, d1, d4);
                tessellator.addVertexWithUV((float)par2 + f18, d, (double)par4 + 0.5D, d2, d4);
                tessellator.addVertexWithUV((float)par2 + f17, d, (double)par4 + 0.5D, d2, d3);
                tessellator.addVertexWithUV((float)par2 + f17, (double)par3 + d5, par4 + 1, d1, d3);
                tessellator.addVertexWithUV((float)par2 + f18, (double)par3 + d5, par4 + 1, d1, d4);
                tessellator.addVertexWithUV((float)par2 + f18, (double)par3 + d5, (double)par4 + 0.75D, d2, d4);
                tessellator.addVertexWithUV((float)par2 + f17, (double)par3 + d5, (double)par4 + 0.75D, d2, d3);
            }
            else if (j == 1)
            {
                tessellator.addVertexWithUV(par2, (double)par3 + d5, (float)par4 + f18, d1, d4);
                tessellator.addVertexWithUV((double)par2 + 0.25D, (double)par3 + d5, (float)par4 + f18, d2, d4);
                tessellator.addVertexWithUV((double)par2 + 0.25D, (double)par3 + d5, (float)par4 + f17, d2, d3);
                tessellator.addVertexWithUV(par2, (double)par3 + d5, (float)par4 + f17, d1, d3);
                tessellator.addVertexWithUV((double)par2 + 0.25D, (double)par3 + d5, (float)par4 + f18, d1, d4);
                tessellator.addVertexWithUV((double)par2 + 0.5D, d, (float)par4 + f18, d2, d4);
                tessellator.addVertexWithUV((double)par2 + 0.5D, d, (float)par4 + f17, d2, d3);
                tessellator.addVertexWithUV((double)par2 + 0.25D, (double)par3 + d5, (float)par4 + f17, d1, d3);
            }
            else
            {
                tessellator.addVertexWithUV((double)par2 + 0.5D, d, (float)par4 + f18, d1, d4);
                tessellator.addVertexWithUV((double)par2 + 0.75D, (double)par3 + d5, (float)par4 + f18, d2, d4);
                tessellator.addVertexWithUV((double)par2 + 0.75D, (double)par3 + d5, (float)par4 + f17, d2, d3);
                tessellator.addVertexWithUV((double)par2 + 0.5D, d, (float)par4 + f17, d1, d3);
                tessellator.addVertexWithUV((double)par2 + 0.75D, (double)par3 + d5, (float)par4 + f18, d1, d4);
                tessellator.addVertexWithUV(par2 + 1, (double)par3 + d5, (float)par4 + f18, d2, d4);
                tessellator.addVertexWithUV(par2 + 1, (double)par3 + d5, (float)par4 + f17, d2, d3);
                tessellator.addVertexWithUV((double)par2 + 0.75D, (double)par3 + d5, (float)par4 + f17, d1, d3);
            }
        }
    ...
    public boolean renderBlockRedstoneWire(Block par1Block, int par2, int par3, int par4)
    {
        ...
        if (!blockAccess.isBlockNormalCube(par2, par3 + 1, par4))
        {
            ...
            if (blockAccess.isBlockNormalCube(par2 - 1, par3, par4) && blockAccess.getBlockId(par2 - 1, par3 + 1, par4) == Block.redstoneWire.blockID)
            {
                ...
                tessellator.addVertexWithUV((double)par2 + 0.015625D, (float)(par3 + 1) + 0.021875F, par4 + 1, d5, d6);
                tessellator.addVertexWithUV((double)par2 + 0.015625D, par3 + 0, par4 + 1, d4, d6);
                tessellator.addVertexWithUV((double)par2 + 0.015625D, par3 + 0, par4 + 0, d4, d7);
                tessellator.addVertexWithUV((double)par2 + 0.015625D, (float)(par3 + 1) + 0.021875F, par4 + 0, d5, d7);
                tessellator.setColorOpaque_F(f, f, f);
                tessellator.addVertexWithUV((double)par2 + 0.015625D, (float)(par3 + 1) + 0.021875F, par4 + 1, d5, d6 + 0.0625D);
                tessellator.addVertexWithUV((double)par2 + 0.015625D, par3 + 0, par4 + 1, d4, d6 + 0.0625D);
                tessellator.addVertexWithUV((double)par2 + 0.015625D, par3 + 0, par4 + 0, d4, d7 + 0.0625D);
                tessellator.addVertexWithUV((double)par2 + 0.015625D, (float)(par3 + 1) + 0.021875F, par4 + 0, d5, d7 + 0.0625D);
            }

            if (blockAccess.isBlockNormalCube(par2 + 1, par3, par4) && blockAccess.getBlockId(par2 + 1, par3 + 1, par4) == Block.redstoneWire.blockID)
            {
                tessellator.setColorOpaque_F(f * f2, f * f3, f * f4);
                tessellator.addVertexWithUV((double)(par2 + 1) - 0.015625D, par3 + 0, par4 + 1, d4, d7);
                tessellator.addVertexWithUV((double)(par2 + 1) - 0.015625D, (float)(par3 + 1) + 0.021875F, par4 + 1, d5, d7);
                tessellator.addVertexWithUV((double)(par2 + 1) - 0.015625D, (float)(par3 + 1) + 0.021875F, par4 + 0, d5, d6);
                tessellator.addVertexWithUV((double)(par2 + 1) - 0.015625D, par3 + 0, par4 + 0, d4, d6);
                tessellator.setColorOpaque_F(f, f, f);
                tessellator.addVertexWithUV((double)(par2 + 1) - 0.015625D, par3 + 0, par4 + 1, d4, d7 + 0.0625D);
                tessellator.addVertexWithUV((double)(par2 + 1) - 0.015625D, (float)(par3 + 1) + 0.021875F, par4 + 1, d5, d7 + 0.0625D);
                tessellator.addVertexWithUV((double)(par2 + 1) - 0.015625D, (float)(par3 + 1) + 0.021875F, par4 + 0, d5, d6 + 0.0625D);
                tessellator.addVertexWithUV((double)(par2 + 1) - 0.015625D, par3 + 0, par4 + 0, d4, d6 + 0.0625D);
            }

            if (blockAccess.isBlockNormalCube(par2, par3, par4 - 1) && blockAccess.getBlockId(par2, par3 + 1, par4 - 1) == Block.redstoneWire.blockID)
            {
                tessellator.setColorOpaque_F(f * f2, f * f3, f * f4);
                tessellator.addVertexWithUV(par2 + 1, par3 + 0, (double)par4 + 0.015625D, d4, d7);
                tessellator.addVertexWithUV(par2 + 1, (float)(par3 + 1) + 0.021875F, (double)par4 + 0.015625D, d5, d7);
                tessellator.addVertexWithUV(par2 + 0, (float)(par3 + 1) + 0.021875F, (double)par4 + 0.015625D, d5, d6);
                tessellator.addVertexWithUV(par2 + 0, par3 + 0, (double)par4 + 0.015625D, d4, d6);
                tessellator.setColorOpaque_F(f, f, f);
                tessellator.addVertexWithUV(par2 + 1, par3 + 0, (double)par4 + 0.015625D, d4, d7 + 0.0625D);
                tessellator.addVertexWithUV(par2 + 1, (float)(par3 + 1) + 0.021875F, (double)par4 + 0.015625D, d5, d7 + 0.0625D);
                tessellator.addVertexWithUV(par2 + 0, (float)(par3 + 1) + 0.021875F, (double)par4 + 0.015625D, d5, d6 + 0.0625D);
                tessellator.addVertexWithUV(par2 + 0, par3 + 0, (double)par4 + 0.015625D, d4, d6 + 0.0625D);
            }

            if (blockAccess.isBlockNormalCube(par2, par3, par4 + 1) && blockAccess.getBlockId(par2, par3 + 1, par4 + 1) == Block.redstoneWire.blockID)
            {
                tessellator.setColorOpaque_F(f * f2, f * f3, f * f4);
                tessellator.addVertexWithUV(par2 + 1, (float)(par3 + 1) + 0.021875F, (double)(par4 + 1) - 0.015625D, d5, d6);
                tessellator.addVertexWithUV(par2 + 1, par3 + 0, (double)(par4 + 1) - 0.015625D, d4, d6);
                tessellator.addVertexWithUV(par2 + 0, par3 + 0, (double)(par4 + 1) - 0.015625D, d4, d7);
                tessellator.addVertexWithUV(par2 + 0, (float)(par3 + 1) + 0.021875F, (double)(par4 + 1) - 0.015625D, d5, d7);
                tessellator.setColorOpaque_F(f, f, f);
                tessellator.addVertexWithUV(par2 + 1, (float)(par3 + 1) + 0.021875F, (double)(par4 + 1) - 0.015625D, d5, d6 + 0.0625D);
                tessellator.addVertexWithUV(par2 + 1, par3 + 0, (double)(par4 + 1) - 0.015625D, d4, d6 + 0.0625D);
                tessellator.addVertexWithUV(par2 + 0, par3 + 0, (double)(par4 + 1) - 0.015625D, d4, d7 + 0.0625D);
                tessellator.addVertexWithUV(par2 + 0, (float)(par3 + 1) + 0.021875F, (double)(par4 + 1) - 0.015625D, d5, d7 + 0.0625D);
            }
        }
    ...
    public boolean renderStandardBlockWithAmbientOcclusion(Block par1Block, int par2, int par3, int par4, float par5, float par6, float par7)
    {
        ...
        float f1 = lightValueOwn;
        float f2 = lightValueOwn;
        ...
        if (renderAllFaces || par1Block.shouldSideBeRendered(blockAccess, par2, par3 - 1, par4, 0))
        {
            ...
            if (aoType > 0)
            {
                ...
                f16 = (aoLightValueYNeg + aoLightValueScratchYZNN + aoLightValueScratchXYPN + aoLightValueScratchXYZPNN) / 4F;
                f10 = (aoLightValueScratchXYNN + aoLightValueScratchXYZNNN + aoLightValueYNeg + aoLightValueScratchYZNN) / 4F;
            ...
            {
                f4 = f10 = f16 = f22 = aoLightValueYNeg;
        ...
        if (renderAllFaces || par1Block.shouldSideBeRendered(blockAccess, par2, par3 + 1, par4, 1))
        {
            ...
            if (aoType > 0)
            {
                ...
                f11 = (aoLightValueYPos + aoLightValueScratchYZPN + aoLightValueScratchXYPP + aoLightValueScratchXYZPPN) / 4F;
                f17 = (aoLightValueScratchXYNP + aoLightValueScratchXYZNPN + aoLightValueYPos + aoLightValueScratchYZPN) / 4F;
            ...
            {
                f5 = f11 = f17 = f23 = aoLightValueYPos;
        ...
        if (renderAllFaces || par1Block.shouldSideBeRendered(blockAccess, par2, par3, par4 - 1, 2))
        {
            ...
            if (aoType > 0)
            {
                ...
                f12 = (aoLightValueZNeg + aoLightValueScratchYZPN + aoLightValueScratchXZPN + aoLightValueScratchXYZPPN) / 4F;
                f18 = (aoLightValueScratchYZNN + aoLightValueZNeg + aoLightValueScratchXYZPNN + aoLightValueScratchXZPN) / 4F;
            ...
            {
                f6 = f12 = f18 = f24 = aoLightValueZNeg;
        ...
        if (renderAllFaces || par1Block.shouldSideBeRendered(blockAccess, par2, par3, par4 + 1, 3))
        {
            ...
            if (aoType > 0)
            {
                ...
                f19 = (aoLightValueScratchYZNP + aoLightValueZPos + aoLightValueScratchXYZPNP + aoLightValueScratchXZPP) / 4F;
                f13 = (aoLightValueScratchXYZNNP + aoLightValueScratchXZNP + aoLightValueScratchYZNP + aoLightValueZPos) / 4F;
            ...
            {
                f7 = f13 = f19 = f25 = aoLightValueZPos;
        ...
        if (renderAllFaces || par1Block.shouldSideBeRendered(blockAccess, par2 - 1, par3, par4, 4))
        {
            ...
            if (aoType > 0)
            {
                ...
                f14 = (aoLightValueScratchXZNN + aoLightValueXNeg + aoLightValueScratchXYZNPN + aoLightValueScratchXYNP) / 4F;
                f20 = (aoLightValueScratchXYZNNN + aoLightValueScratchXYNN + aoLightValueScratchXZNN + aoLightValueXNeg) / 4F;
            ...
            {
                f8 = f14 = f20 = f26 = aoLightValueXNeg;
        ...
        if (renderAllFaces || par1Block.shouldSideBeRendered(blockAccess, par2 + 1, par3, par4, 5))
        {
            ...
            if (aoType > 0)
            {
                ...
                f21 = (aoLightValueScratchXZPN + aoLightValueXPos + aoLightValueScratchXYZPPN + aoLightValueScratchXYPP) / 4F;
                f15 = (aoLightValueScratchXYZPNN + aoLightValueScratchXYPN + aoLightValueScratchXZPN + aoLightValueXPos) / 4F;
            ...
            {
                f9 = f15 = f21 = f27 = aoLightValueXPos;
    ...
    public static boolean renderItemIn3d(int par0)
    {
        ...
        {
            return ModLoader.renderBlockIsItemFull3D(par0);
        }
    }
}
