...
public class GuiSnooper extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        for (Iterator iterator1 = (new TreeMap(mc.getPlayerUsageSnooper().getCurrentStats())).entrySet().iterator(); iterator1.hasNext(); field_74096_d.add(fontRenderer.trimStringToWidth((String)entry.getValue(), width - 210)))
        {
