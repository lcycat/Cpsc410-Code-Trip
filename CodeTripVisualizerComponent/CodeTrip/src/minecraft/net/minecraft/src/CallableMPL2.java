...
class CallableMPL2 implements Callable
{
    ...
    {
        return (new StringBuilder()).append(WorldClient.getEntitySpawnQueue(worldClientMPL2).size()).append(" total; ").append(WorldClient.getEntitySpawnQueue(worldClientMPL2).toString()).toString();
    }
