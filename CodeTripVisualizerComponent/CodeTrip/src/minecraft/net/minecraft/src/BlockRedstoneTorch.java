...
public class BlockRedstoneTorch extends BlockTorch
{
    ...
    private boolean checkForBurnout(World par1World, int par2, int par3, int par4, boolean par5)
    {
        ...
        for (Iterator iterator = ((List)redstoneUpdateInfoCache.get(par1World)).iterator(); iterator.hasNext();)
        {
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        for (List list = (List)redstoneUpdateInfoCache.get(par1World); list != null && !list.isEmpty() && par1World.getWorldTime() - ((RedstoneUpdateInfo)list.get(0)).updateTime > 60L; list.remove(0)) { }
