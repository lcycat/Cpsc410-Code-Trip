...
public class Vec3
{
    ...
    {
        return getVec3Pool().getVecFromPool(par1Vec3.xCoord - xCoord, par1Vec3.yCoord - yCoord, par1Vec3.zCoord - zCoord);
    }
    ...
    public Vec3 normalize()
    {
        ...
        if (d < 0.0001D)
        {
            return getVec3Pool().getVecFromPool(0.0D, 0.0D, 0.0D);
        }
        else
        {
            return getVec3Pool().getVecFromPool(xCoord / d, yCoord / d, zCoord / d);
        }
    }
    ...
    {
        return getVec3Pool().getVecFromPool(yCoord * par1Vec3.zCoord - zCoord * par1Vec3.yCoord, zCoord * par1Vec3.xCoord - xCoord * par1Vec3.zCoord, xCoord * par1Vec3.yCoord - yCoord * par1Vec3.xCoord);
    }
    ...
    {
        return getVec3Pool().getVecFromPool(xCoord + par1, yCoord + par3, zCoord + par5);
    }
    ...
    public Vec3 getIntermediateWithXValue(Vec3 par1Vec3, double par2)
    {
        ...
        {
            return getVec3Pool().getVecFromPool(xCoord + d * d3, yCoord + d1 * d3, zCoord + d2 * d3);
        }
    }
