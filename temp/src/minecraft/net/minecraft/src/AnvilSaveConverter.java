...
public class AnvilSaveConverter extends SaveFormatOld
{
    ...
    public List func_75799_b()
    {
        ...
        File afile[] = field_75808_a.listFiles();
        File afile1[] = afile;
        int i = afile1.length;
        for(int j = 0; j < i; j++)
        {
            ...
            boolean flag = worldinfo.func_76088_k() != func_75812_c();
            ...
            long l = 0L;
            arraylist.add(new SaveFormatComparator(s, s1, worldinfo.func_76057_l(), l, worldinfo.func_76077_q(), flag, worldinfo.func_76093_s(), worldinfo.func_76086_u()));
        }
