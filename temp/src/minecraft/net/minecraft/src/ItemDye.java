...
//            Item, CreativeTabs, MathHelper, ItemStack, 
...
public class ItemDye extends Item
{
    ...
    {
        int i = MathHelper.func_76125_a(p_77617_1_, 0, 15);
        return field_77791_bV + (i % 8) * 16 + i / 8;
    }
...
label0:
    ...
    public void func_77633_a(int p_77633_1_, CreativeTabs p_77633_2_, List p_77633_3_)
    {
        for(int i = 0; i < 16; i++)
        {
            p_77633_3_.add(new ItemStack(p_77633_1_, 1, i));
        }
