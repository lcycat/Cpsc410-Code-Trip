    ...
    implements IInventory
{
    ...
    {
        return (field_70406_c * p_70397_1_) / 200;
    }
    ...
    public int func_70403_d(int p_70403_1_)
    {
        ...
        return (field_70407_a * p_70403_1_) / field_70405_b;
    }
                ...
                if(field_70407_a > 0)
                {
                    ...
                    if(field_70404_d[1] != null)
                    {
                        ...
                        if(field_70404_d[1].field_77994_a == 0)
                        {
                            ...
                            field_70404_d[1] = item != null ? new ItemStack(item) : null;
                        }
                    }
                }
            }
    ...
    private boolean func_70402_r()
    {
        ...
        if(!field_70404_d[2].func_77969_a(itemstack))
        {
            return false;
        }
        if(field_70404_d[2].field_77994_a < func_70297_j_() && field_70404_d[2].field_77994_a < field_70404_d[2].func_77976_d())
        {
            return true;
        } else
        {
            return field_70404_d[2].field_77994_a < itemstack.func_77976_d();
        }
    }
    ...
    public void func_70399_k()
    {
        ...
        {
            Item item = field_70404_d[0].func_77973_b().func_77668_q();
            field_70404_d[0] = item != null ? new ItemStack(item) : null;
        }
    }
    ...
    public static int func_70398_a(ItemStack p_70398_0_)
    {
        ...
        {
            return ModLoader.addAllFuel(p_70398_0_.field_77993_c, p_70398_0_.func_77960_j());
        }
    }
