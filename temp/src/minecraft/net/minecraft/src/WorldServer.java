...
public class WorldServer extends World
{
    ...
    {
        if(field_72986_A.func_76075_d() <= 0)
        {
            field_72986_A.func_76056_b(64);
        }
        int i = field_72986_A.func_76079_c();
        int j = field_72986_A.func_76074_e();
        int k = 0;
        do
        {
            if(func_72922_b(i, j) != 0)
            {
                break;
            }
            i += field_73012_v.nextInt(8) - field_73012_v.nextInt(8);
            j += field_73012_v.nextInt(8) - field_73012_v.nextInt(8);
        } while(++k != 10000);
        field_72986_A.func_76058_a(i);
        field_72986_A.func_76087_c(j);
    }
