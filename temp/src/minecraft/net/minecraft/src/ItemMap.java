...
//            ItemMapBase, CreativeTabs, MapData, World, 
//            ItemStack, WorldInfo, WorldProvider, Entity, 
...
public class ItemMap extends ItemMapBase
{
    ...
    {
        String s = (new StringBuilder()).append("map_").append(p_77874_0_).toString();
        MapData mapdata = (MapData)p_77874_1_.func_72943_a(net.minecraft.src.MapData.class, (new StringBuilder()).append("map_").append(p_77874_0_).toString());
        if(mapdata == null)
        {
            int i = p_77874_1_.func_72841_b("map");
            String s1 = (new StringBuilder()).append("map_").append(i).toString();
            mapdata = new MapData(s1);
            p_77874_1_.func_72823_a(s1, mapdata);
        }
        return mapdata;
    }
