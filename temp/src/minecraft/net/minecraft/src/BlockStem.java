...
public class BlockStem extends BlockFlower
{
    ...
    {
        return func_71889_f_(p_71920_1_.func_72805_g(p_71920_2_, p_71920_3_, p_71920_4_));
    }
    ...
    {
        int i = p_72265_1_.func_72805_g(p_72265_2_, p_72265_3_, p_72265_4_);
        if(i < 7)
        {
            return -1;
        }
        if(p_72265_1_.func_72798_a(p_72265_2_ - 1, p_72265_3_, p_72265_4_) == field_72267_a.field_71990_ca)
        {
            return 0;
        }
        if(p_72265_1_.func_72798_a(p_72265_2_ + 1, p_72265_3_, p_72265_4_) == field_72267_a.field_71990_ca)
        ...
        if(p_72265_1_.func_72798_a(p_72265_2_, p_72265_3_, p_72265_4_ - 1) == field_72267_a.field_71990_ca)
        {
            return 2;
        }
        return p_72265_1_.func_72798_a(p_72265_2_, p_72265_3_, p_72265_4_ + 1) != field_72267_a.field_71990_ca ? -1 : 3;
    }
    ...
    public int func_71922_a(World p_71922_1_, int p_71922_2_, int p_71922_3_, int p_71922_4_)
    {
        if(field_72267_a == Block.field_72061_ba)
        {
            return Item.field_77739_bg.field_77779_bT;
        }
        if(field_72267_a == Block.field_71997_br)
        {
            return Item.field_77740_bh.field_77779_bT;
        } else
        {
            return 0;
        }
