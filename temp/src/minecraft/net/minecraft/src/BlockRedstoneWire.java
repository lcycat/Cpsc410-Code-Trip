...
public class BlockRedstoneWire extends Block
{
    ...
    public void func_71862_a(World p_71862_1_, int p_71862_2_, int p_71862_3_, int p_71862_4_, Random p_71862_5_)
    {
        ...
        if(i > 0)
        {
            double d = (double)p_71862_2_ + 0.5D + ((double)p_71862_5_.nextFloat() - 0.5D) * 0.20000000000000001D;
            double d1 = (float)p_71862_3_ + 0.0625F;
            double d2 = (double)p_71862_4_ + 0.5D + ((double)p_71862_5_.nextFloat() - 0.5D) * 0.20000000000000001D;
            float f = (float)i / 15F;
            ...
            p_71862_1_.func_72869_a("reddust", d, d1, d2, f1, f2, f3);
        }
    }
