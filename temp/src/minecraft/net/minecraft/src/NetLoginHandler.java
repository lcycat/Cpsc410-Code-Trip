...
//            ThreadLoginVerifier, ServerConfigurationManager, DedicatedServerListenThread, Packet1Login, 
//            Packet254ServerPing, Packet
...
public class NetLoginHandler extends NetHandler
{
    ...
    public void func_72500_a(Packet2ClientProtocol p_72500_1_)
    {
        ...
        java.security.PublicKey publickey = field_72534_f.func_71250_E().getPublic();
    ...
    {
        java.security.PrivateKey privatekey = field_72534_f.func_71250_E().getPrivate();
    ...
    public String func_72528_e()
    {
        ...
        {
            return (new StringBuilder()).append(field_72543_h).append(" [").append(field_72538_b.func_74430_c().toString()).append("]").toString();
        } else
        {
            return field_72538_b.func_74430_c().toString();
        }
    }
