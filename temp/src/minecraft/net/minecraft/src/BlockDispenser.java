...
//            World, IBlockAccess, TileEntityDispenser, EntityPlayer, 
//            ItemStack, EntityLiving, MathHelper, EntityItem, 
//            NBTTagCompound, Item, EntityArrow, EntityEgg, 
//            EntitySnowball, ItemPotion, EntityPotion, EntityExpBottle, 
//            ItemMonsterPlacer, EntitySmallFireball, ItemBucket, ItemMinecart, 
//            BlockRail, EntityMinecart, EntityBoat, ModLoader, 
//            TileEntity
...
label0:
            ...
            int p_72283_8_, double p_72283_9_, double p_72283_11_, double p_72283_13_)
    {
        ...
        {
            p_72283_9_ = (double)p_72283_4_ + (p_72283_7_ < 0 ? (double)p_72283_7_ * 0.80000000000000004D : (float)p_72283_7_ * 1.8F) + (double)((float)Math.abs(p_72283_8_) * 0.5F);
            p_72283_13_ = (double)p_72283_6_ + (p_72283_8_ < 0 ? (double)p_72283_8_ * 0.80000000000000004D : (float)p_72283_8_ * 1.8F) + (double)((float)Math.abs(p_72283_7_) * 0.5F);
