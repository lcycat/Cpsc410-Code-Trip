...
//            ItemBlock, Block, ItemStack, BlockHalfSlab, 
...
public class ItemSlab extends ItemBlock
{
    ...
    {
        return Block.field_71973_m[field_77779_bT].func_71858_a(2, p_77617_1_);
    }
    ...
    public boolean func_77884_a(World p_77884_1_, int p_77884_2_, int p_77884_3_, int p_77884_4_, int p_77884_5_, EntityPlayer p_77884_6_, ItemStack p_77884_7_)
    {
        ...
        int j = p_77884_3_;
        int k = p_77884_4_;
        int l = p_77884_1_.func_72798_a(p_77884_2_, p_77884_3_, p_77884_4_);
        int i1 = p_77884_1_.func_72805_g(p_77884_2_, p_77884_3_, p_77884_4_);
        int j1 = i1 & 7;
        boolean flag = (i1 & 8) != 0;
        if((p_77884_5_ == 1 && !flag || p_77884_5_ == 0 && flag) && l == field_77889_b.field_71990_ca && j1 == p_77884_7_.func_77960_j())
        {
            return true;
        }
        if(p_77884_5_ == 0)
        ...
        l = p_77884_1_.func_72798_a(p_77884_2_, p_77884_3_, p_77884_4_);
        i1 = p_77884_1_.func_72805_g(p_77884_2_, p_77884_3_, p_77884_4_);
        j1 = i1 & 7;
        flag = (i1 & 8) != 0;
        if(l == field_77889_b.field_71990_ca && j1 == p_77884_7_.func_77960_j())
        {
            return true;
        } else
        {
            return super.func_77884_a(p_77884_1_, i, j, k, p_77884_5_, p_77884_6_, p_77884_7_);
        }
    }
