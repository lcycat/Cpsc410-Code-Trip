...
public class WorldGenForest extends WorldGenerator
{
    ...
    public boolean func_76484_a(World p_76484_1_, Random p_76484_2_, int p_76484_3_, int p_76484_4_, int p_76484_5_)
    {
        ...
        for(int j = p_76484_4_; j <= p_76484_4_ + 1 + i; j++)
        {
            ...
            for(int j1 = p_76484_3_ - byte0; j1 <= p_76484_3_ + byte0 && flag; j1++)
            {
                for(int i2 = p_76484_5_ - byte0; i2 <= p_76484_5_ + byte0 && flag; i2++)
                {
                    if(j >= 0 && j < 256)
                    {
                        int k2 = p_76484_1_.func_72798_a(j1, j, i2);
        ...
        {
            int k1 = l - (p_76484_4_ + i);
            int j2 = 1 - k1 / 2;
            for(int l2 = p_76484_3_ - j2; l2 <= p_76484_3_ + j2; l2++)
            {
                int i3 = l2 - p_76484_3_;
                for(int j3 = p_76484_5_ - j2; j3 <= p_76484_5_ + j2; j3++)
                {
                    int k3 = j3 - p_76484_5_;
                    if((Math.abs(i3) != j2 || Math.abs(k3) != j2 || p_76484_2_.nextInt(2) != 0 && k1 != 0) && !Block.field_71970_n[p_76484_1_.func_72798_a(l2, l, j3)])
                    {
                        func_76485_a(p_76484_1_, l2, l, j3, Block.field_71952_K.field_71990_ca, 2);
                    }
                }
        ...
        {
            int l1 = p_76484_1_.func_72798_a(p_76484_3_, p_76484_4_ + i1, p_76484_5_);
            if(l1 == 0 || l1 == Block.field_71952_K.field_71990_ca)
            {
                func_76485_a(p_76484_1_, p_76484_3_, p_76484_4_ + i1, p_76484_5_, Block.field_71951_J.field_71990_ca, 2);
            }
        }
