...
public abstract class Enchantment
{
    ...
    {
        return (new StringBuilder()).append("enchantment.").append(field_77350_z).toString();
    }

    public String func_77316_c(int p_77316_1_)
    {
        String s = StatCollector.func_74838_a(func_77320_a());
        return (new StringBuilder()).append(s).append(" ").append(StatCollector.func_74838_a((new StringBuilder()).append("enchantment.level.").append(p_77316_1_).toString())).toString();
    }
