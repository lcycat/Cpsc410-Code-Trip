...
class CanvasMojangLogo extends Canvas
{
    ...
    public CanvasMojangLogo()
    {
        try
        {
            field_74537_a = ImageIO.read((net.minecraft.src.PanelCrashReport.class).getResource("/gui/crash_logo.png"));
        }
    ...
    public void paint(Graphics p_paint_1_)
    {
        ...
        p_paint_1_.drawImage(field_74537_a, getWidth() / 2 - field_74537_a.getWidth() / 2, 32, null);
    }
}
