...
//            BaseModMp, Packet100OpenWindow, EntityClientPlayerMP, Container, 
...
public class ModLoaderMp
{
            ...
            if(netclienthandlerentity != null && (net.minecraft.src.ISpawnable.class).isAssignableFrom(netclienthandlerentity.entityClass))
            {
                try
                {
                    Entity entity = (Entity)netclienthandlerentity.entityClass.getConstructor(new Class[] {
                        ...
                        ModLoader.getMinecraftInstance().field_71441_e
                    });
    ...
    public static void handleGUI(Packet100OpenWindow packet100openwindow)
    {
        ...
        BaseModMp basemodmp = (BaseModMp)guiModMap.get(Integer.valueOf(packet100openwindow.field_73429_b));
        ...
        if(guiscreen != null)
        {
            ...
            ModLoader.getMinecraftInstance().field_71439_g.field_71070_bA.field_75152_c = packet100openwindow.field_73431_a;
        }
    }
    ...
    {
        if(packet230Received && ModLoader.getMinecraftInstance().field_71441_e != null && ModLoader.getMinecraftInstance().field_71441_e.field_72995_K)
        {
