...
public class BlockEnderChest extends BlockContainer
{
    ...
    public void func_71862_a(World p_71862_1_, int p_71862_2_, int p_71862_3_, int p_71862_4_, Random p_71862_5_)
    {
        for(int i = 0; i < 3; i++)
        {
            ...
            int k = p_71862_5_.nextInt(2) * 2 - 1;
            d3 = ((double)p_71862_5_.nextFloat() - 0.5D) * 0.125D;
            d4 = ((double)p_71862_5_.nextFloat() - 0.5D) * 0.125D;
            d5 = ((double)p_71862_5_.nextFloat() - 0.5D) * 0.125D;
            d2 = (double)p_71862_4_ + 0.5D + 0.25D * (double)k;
            d5 = p_71862_5_.nextFloat() * 1.0F * (float)k;
            d = (double)p_71862_2_ + 0.5D + 0.25D * (double)j;
            d3 = p_71862_5_.nextFloat() * 1.0F * (float)j;
