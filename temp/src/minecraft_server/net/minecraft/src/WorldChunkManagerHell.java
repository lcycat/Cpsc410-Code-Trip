...
public class WorldChunkManagerHell extends WorldChunkManager
{
    ...
    {
        field_76947_d = p_i3755_1_;
        field_76948_e = p_i3755_2_;
        field_76946_f = p_i3755_3_;
    }

    public BiomeGenBase func_76935_a(int p_76935_1_, int p_76935_2_)
    {
        return field_76947_d;
    }
    ...
    public BiomeGenBase[] func_76937_a(BiomeGenBase p_76937_1_[], int p_76937_2_, int p_76937_3_, int p_76937_4_, int p_76937_5_)
    {
        ...
        Arrays.fill(p_76937_1_, 0, p_76937_4_ * p_76937_5_, field_76947_d);
        return p_76937_1_;
    }
    ...
    public float[] func_76934_b(float p_76934_1_[], int p_76934_2_, int p_76934_3_, int p_76934_4_, int p_76934_5_)
    {
        ...
        Arrays.fill(p_76934_1_, 0, p_76934_4_ * p_76934_5_, field_76948_e);
        return p_76934_1_;
    }
    ...
    public float[] func_76936_a(float p_76936_1_[], int p_76936_2_, int p_76936_3_, int p_76936_4_, int p_76936_5_)
    {
        ...
        Arrays.fill(p_76936_1_, 0, p_76936_4_ * p_76936_5_, field_76946_f);
        return p_76936_1_;
    }
    ...
    public BiomeGenBase[] func_76933_b(BiomeGenBase p_76933_1_[], int p_76933_2_, int p_76933_3_, int p_76933_4_, int p_76933_5_)
    {
        ...
        Arrays.fill(p_76933_1_, 0, p_76933_4_ * p_76933_5_, field_76947_d);
        return p_76933_1_;
    }
    ...
    {
        return func_76933_b(p_76931_1_, p_76931_2_, p_76931_3_, p_76931_4_, p_76931_5_);
    }

    public ChunkPosition func_76941_a(int p_76941_1_, int p_76941_2_, int p_76941_3_, List p_76941_4_, Random p_76941_5_)
    {
        if(p_76941_4_.contains(field_76947_d))
        {
            return new ChunkPosition((p_76941_1_ - p_76941_3_) + p_76941_5_.nextInt(p_76941_3_ * 2 + 1), 0, (p_76941_2_ - p_76941_3_) + p_76941_5_.nextInt(p_76941_3_ * 2 + 1));
        } else
        {
            return null;
        }
    ...
    {
        return p_76940_4_.contains(field_76947_d);
    }
}
