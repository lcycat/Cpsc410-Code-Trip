...
label0:
    ...
    private static int func_70944_b(int p_70944_0_, Random p_70944_1_)
    {
        ...
        return tuple != null ? ((Integer)tuple.func_76341_a()).intValue() < ((Integer)tuple.func_76340_b()).intValue() ? ((Integer)tuple.func_76341_a()).intValue() + p_70944_1_.nextInt(((Integer)tuple.func_76340_b()).intValue() - ((Integer)tuple.func_76341_a()).intValue()) : ((Integer)tuple.func_76341_a()).intValue() : 1;
    }
    ...
    private static int func_70943_c(int p_70943_0_, Random p_70943_1_)
    {
        ...
        return tuple != null ? ((Integer)tuple.func_76341_a()).intValue() < ((Integer)tuple.func_76340_b()).intValue() ? ((Integer)tuple.func_76341_a()).intValue() + p_70943_1_.nextInt(((Integer)tuple.func_76340_b()).intValue() - ((Integer)tuple.func_76341_a()).intValue()) : ((Integer)tuple.func_76341_a()).intValue() : 1;
    }
