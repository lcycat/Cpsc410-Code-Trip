...
//            ServerConfigurationManager, Packet10Flying, WorldServer, Entity, 
...
//            ChatAllowedCharacters, ModLoaderMp, ICommandManager, Packet18Animation, 
//            Packet19EntityAction, Packet7UseEntity, Packet205ClientCommand, WorldInfo, 
//            BanEntry, BanList, Packet102WindowClick, Packet106Transaction, 
//            Packet108EnchantItem, Packet107CreativeSetSlot, Item, EntityItem, 
//            Packet130UpdateSign, TileEntitySign, TileEntity, Packet202PlayerAbilities, 
//            PlayerCapabilities, Packet203AutoComplete, Packet250CustomPayload, Packet, 
//            ItemWritableBook, ItemEditableBook, ContainerMerchant, Packet9Respawn, 
//            Packet101CloseWindow, Packet204ClientInfo
...
public class NetServerHandler extends NetHandler
{
        ...
        if(!field_72574_e.field_71136_j)
        {
            ...
            if(field_72587_r)
            {
                if(field_72574_e.field_70154_o != null)
                {
                    ...
                    float f2 = field_72574_e.field_70125_A;
                    ...
                    if(p_72498_1_.field_73546_h && p_72498_1_.field_73543_b == -999D && p_72498_1_.field_73541_d == -999D)
                    {
                        ...
                        d11 = p_72498_1_.field_73545_a;
                        d8 = p_72498_1_.field_73544_c;
                    }
                    field_72574_e.field_70122_E = p_72498_1_.field_73540_g;
                    field_72574_e.func_71127_g();
                    field_72574_e.func_70091_d(d11, 0.0D, d8);
                    field_72574_e.func_70080_a(d2, d4, d6, f, f2);
                    field_72574_e.field_70159_w = d11;
                    field_72574_e.field_70179_y = d8;
                    if(field_72574_e.field_70154_o != null)
                    {
                ...
                float f1 = field_72574_e.field_70177_z;
                ...
                if(p_72498_1_.field_73546_h)
                {
                    ...
                    double d9 = p_72498_1_.field_73541_d - p_72498_1_.field_73543_b;
                    if(!field_72574_e.func_70608_bn() && (d9 > 1.6499999999999999D || d9 < 0.10000000000000001D))
                    {
                        func_72565_c("Illegal stance");
                        field_72577_a.warning((new StringBuilder()).append(field_72574_e.field_71092_bJ).append(" had an illegal stance: ").append(d9).toString());
                        return;
                    }
                ...
                if(p_72498_1_.field_73547_i)
                {
                    f1 = p_72498_1_.field_73542_e;
                    f3 = p_72498_1_.field_73539_f;
                }
                field_72574_e.func_71127_g();
                field_72574_e.field_70139_V = 0.0F;
                field_72574_e.func_70080_a(field_72579_o, field_72589_p, field_72588_q, f1, f3);
                if(!field_72587_r)
                {
                    return;
                }
                double d10 = d3 - field_72574_e.field_70165_t;
                double d12 = d5 - field_72574_e.field_70163_u;
                double d13 = d7 - field_72574_e.field_70161_v;
                double d14 = Math.min(Math.abs(d10), Math.abs(field_72574_e.field_70159_w));
                ...
                {
                    field_72577_a.warning((new StringBuilder()).append(field_72574_e.field_71092_bJ).append(" moved too quickly! ").append(d10).append(",").append(d12).append(",").append(d13).append(" (").append(d14).append(", ").append(d15).append(", ").append(d16).append(")").toString());
                ...
                field_72574_e.func_70091_d(d10, d12, d13);
                field_72574_e.field_70122_E = p_72498_1_.field_73540_g;
                field_72574_e.func_71000_j(d10, d12, d13);
                double d18 = d12;
                d10 = d3 - field_72574_e.field_70165_t;
                ...
                field_72574_e.func_70080_a(d3, d5, d7, f1, f3);
                ...
                {
                    func_72569_a(field_72579_o, field_72589_p, field_72588_q, f1, f3);
                    return;
                }
    ...
    {
        if(ModLoaderMp.handleCommand(p_72566_1_.substring(1), field_72574_e.field_71092_bJ, field_72577_a, field_72573_d.field_71318_t.func_72353_e(field_72574_e.field_71092_bJ)))
        {
            field_72577_a.info((new StringBuilder()).append("ModLoaderMP : ").append(field_72574_e.field_71092_bJ).append(" issued command: ").append(p_72566_1_.substring(1)).toString());
        } else
    ...
    public void func_72464_a(Packet107CreativeSetSlot p_72464_1_)
    {
        if(field_72574_e.field_71134_c.func_73083_d())
        {
            ...
            if(flag1 && flag2 && flag3)
            {
                if(itemstack == null)
                {
                    field_72574_e.field_71069_bz.func_75141_a(p_72464_1_.field_73385_a, (ItemStack)null);
                } else
                {
    ...
    public void func_72487_a(Packet130UpdateSign p_72487_1_)
    {
        ...
        if(worldserver.func_72899_e(p_72487_1_.field_73311_a, p_72487_1_.field_73309_b, p_72487_1_.field_73310_c))
        {
            ...
            {
                boolean flag = true;
                if(p_72487_1_.field_73308_d[k].length() > 15)
                {
                    flag = false;
                } else
                {
                    for(int i = 0; i < p_72487_1_.field_73308_d[k].length(); i++)
                    {
                        if(ChatAllowedCharacters.field_71568_a.indexOf(p_72487_1_.field_73308_d[k].charAt(i)) < 0)
                        {
                            flag = false;
                        }
                    }
                ...
                if(!flag)
                {
                    p_72487_1_.field_73308_d[k] = "!?";
                }
            }

            if(tileentity instanceof TileEntitySign)
            {
                int l = p_72487_1_.field_73311_a;
                int i1 = p_72487_1_.field_73309_b;
                int j = p_72487_1_.field_73310_c;
                TileEntitySign tileentitysign1 = (TileEntitySign)tileentity;
                System.arraycopy(p_72487_1_.field_73308_d, 0, tileentitysign1.field_70412_a, 0, 4);
                tileentitysign1.func_70296_d();
                worldserver.func_72845_h(l, i1, j);
            }
        }
    }
