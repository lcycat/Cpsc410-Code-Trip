...
//            Packet28EntityVelocity, Packet, DataWatcher, Packet40EntityMetadata, 
//            Packet35EntityHeadRotation, EntityPlayerMP, NetServerHandler, Packet24MobSpawn, 
//            Packet5PlayerInventory, EntityPlayer, Packet17Sleep, EntityLiving, 
//            PotionEffect, Packet41EntityEffect, WorldServer, PlayerManager, 
...
//            EntityPotion, EntityExpBottle, EntityEnderPearl, EntityEnderEye, 
//            EntitySmallFireball, EntityFireball, EntityEgg, EntityTNTPrimed, 
//            EntityEnderCrystal, EntityFallingSand, EntityPainting, Packet25EntityPainting, 
...
public class EntityTrackerEntry
{
    ...
    {
        return (p_equals_1_ instanceof EntityTrackerEntry) ? ((EntityTrackerEntry)p_equals_1_).field_73132_a.field_70157_k == field_73132_a.field_70157_k : false;
    }
    ...
    private Packet func_73124_b()
    {
        ...
        EntityTrackerEntry2 entitytrackerentry2 = ModLoaderMp.handleEntityTrackerEntries(field_73132_a);
        if(entitytrackerentry2 != null)
        {
            try
            {
                if(field_73132_a instanceof ISpawnable)
                {
                    Packet230ModLoader packet230modloader = ((ISpawnable)field_73132_a).getSpawnPacket();
                ...
                {
                    return new Packet23VehicleSpawn(field_73132_a, entitytrackerentry2.entityId);
                }
                Field field = field_73132_a.getClass().getField("owner");
                if((net.minecraft.src.Entity.class).isAssignableFrom(field.getType()))
                {
                    Entity entity1 = (Entity)field.get(field_73132_a);
                    return new Packet23VehicleSpawn(field_73132_a, entitytrackerentry2.entityId, entity1 == null ? field_73132_a.field_70157_k : entity1.field_70157_k);
                } else
                {
        ...
        if(!(field_73132_a instanceof IAnimals) && !(field_73132_a instanceof EntityDragon))
        {
            if(field_73132_a instanceof EntityFishHook)
            {
                ...
                return new Packet23VehicleSpawn(field_73132_a, 90, entityplayer == null ? field_73132_a.field_70157_k : entityplayer.field_70157_k);
            }
