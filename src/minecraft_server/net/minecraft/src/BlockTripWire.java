...
public class BlockTripWire extends Block
{
    ...
    {
        byte byte0 = ((byte)(par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4) ? 0 : 2));
    ...
    private void func_72149_e(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        for (int i = 0; i < 2; i++)
        {
            ...
            do
            {
                ...
                if (i1 == Block.field_72064_bT.blockID)
                {
                    int j1 = par1World.getBlockMetadata(k, par3, l) & 3;

                    if (j1 == Direction.footInvisibleFaceRemap[i])
                    {
                        Block.field_72064_bT.func_72143_a(par1World, k, par3, l, i1, par1World.getBlockMetadata(k, par3, l), true, j, par5);
                    }

                    continue label0;
                }

                if (i1 != Block.field_72062_bU.blockID)
                {
                    continue label0;
                }
