...
public class BlockPumpkin extends BlockDirectional
{
    ...
    protected BlockPumpkin(int par1, int par2, boolean par3)
    {
        ...
        blockType = par3;
        setCreativeTab(CreativeTabs.field_78030_b);
    }
    ...
    public boolean canPlaceBlockAt(World par1World, int par2, int par3, int par4)
    {
        ...
        return (i == 0 || Block.blocksList[i].blockMaterial.isGroundCover()) && par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4);
    }
