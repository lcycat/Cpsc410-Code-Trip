...
public class WorldGeneratorBonusChest extends WorldGenerator
{
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        for (int j = 0; j < 4; j++)
        {
            ...
            if (par1World.isAirBlock(k, l, i1) && par1World.doesBlockHaveSolidTopSurface(k, l - 1, i1))
            {
                ...
                if (par1World.isAirBlock(k - 1, l, i1) && par1World.doesBlockHaveSolidTopSurface(k - 1, l - 1, i1))
                {
                ...
                if (par1World.isAirBlock(k, l, i1 - 1) && par1World.doesBlockHaveSolidTopSurface(k - 1, l - 1, i1))
                {
