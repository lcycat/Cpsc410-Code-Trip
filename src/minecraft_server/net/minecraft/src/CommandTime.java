...
public class CommandTime extends CommandBase
{
    ...
    {
        for (int i = 0; i < MinecraftServer.getServer().worldMngr.length; i++)
        {
            MinecraftServer.getServer().worldMngr[i].setTime(par2);
        }
    }
    ...
    protected void addTime(ICommandSender par1ICommandSender, int par2)
    {
        for (int i = 0; i < MinecraftServer.getServer().worldMngr.length; i++)
        {
            WorldServer worldserver = MinecraftServer.getServer().worldMngr[i];
