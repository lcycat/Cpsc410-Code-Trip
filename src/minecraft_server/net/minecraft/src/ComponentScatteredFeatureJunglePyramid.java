...
public class ComponentScatteredFeatureJunglePyramid extends ComponentScatteredFeature
{
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        placeBlockAtCurrentPosition(par1World, Block.field_72064_bT.blockID, getMetadataWithOffset(Block.field_72064_bT.blockID, 3) | 4, 1, -3, 8, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_72064_bT.blockID, getMetadataWithOffset(Block.field_72064_bT.blockID, 1) | 4, 4, -3, 8, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_72062_bU.blockID, 4, 2, -3, 8, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_72062_bU.blockID, 4, 3, -3, 8, par3StructureBoundingBox);
        ...
        placeBlockAtCurrentPosition(par1World, Block.field_72064_bT.blockID, getMetadataWithOffset(Block.field_72064_bT.blockID, 2) | 4, 7, -3, 1, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_72064_bT.blockID, getMetadataWithOffset(Block.field_72064_bT.blockID, 0) | 4, 7, -3, 5, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_72062_bU.blockID, 4, 7, -3, 2, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_72062_bU.blockID, 4, 7, -3, 3, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_72062_bU.blockID, 4, 7, -3, 4, par3StructureBoundingBox);
