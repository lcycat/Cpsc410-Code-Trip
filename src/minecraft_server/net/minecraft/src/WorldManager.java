...
public class WorldManager implements IWorldAccess
{
    ...
    {
        world.getEntityTracker().trackEntity(par1Entity);
    }
    ...
    {
        world.getEntityTracker().untrackEntity(par1Entity);
    }
    ...
    {
        mcServer.func_71203_ab().sendPacketToPlayersAroundPoint(par2, par4, par6, par8 <= 1.0F ? 16D : 16F * par8, world.provider.worldType, new Packet62LevelSound(par1Str, par2, par4, par6, par8, par9));
    }
    ...
    {
        world.func_73040_p().markBlockNeedsUpdate(par1, par2, par3);
    }
    ...
    {
        mcServer.func_71203_ab().func_72397_a(par1EntityPlayer, par3, par4, par5, 64D, world.provider.worldType, new Packet61DoorChange(par2, par3, par4, par5, par6));
    }
    ...
    {
        Iterator iterator = mcServer.func_71203_ab().playerEntities.iterator();
