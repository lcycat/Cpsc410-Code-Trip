...
public class ChunkProviderServer implements IChunkProvider
{
    ...
    public void unloadAllChunks()
    {
        ...
        for (Iterator iterator = field_73245_g.iterator(); iterator.hasNext(); dropChunk(chunk.xPosition, chunk.zPosition))
        {
    ...
    public Chunk provideChunk(int par1, int par2)
    {
        ...
        return chunk != null ? chunk : world.findingSpawnPoint || chunkLoadOverride ? loadChunk(par1, par2) : dummyChunk;
    }
