...
public class CommandServerBanlist extends CommandBase
{
    ...
    public void processCommand(ICommandSender par1ICommandSender, String par2ArrayOfStr[])
    {
        ...
        {
            par1ICommandSender.func_70006_a(par1ICommandSender.translateString("commands.banlist.ips", new Object[]
                    {
                        Integer.valueOf(MinecraftServer.getServer().func_71203_ab().func_72363_f().func_73712_c().size())
                    }));
        ...
        {
            par1ICommandSender.func_70006_a(par1ICommandSender.translateString("commands.banlist.players", new Object[]
                    {
                        Integer.valueOf(MinecraftServer.getServer().func_71203_ab().func_72390_e().func_73712_c().size())
                    }));
