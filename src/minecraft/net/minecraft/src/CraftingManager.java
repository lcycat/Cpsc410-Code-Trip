...
public class CraftingManager
{
    ...
    private CraftingManager()
    {
        ...
        addRecipe(new ItemStack(Block.stoneSingleSlab, 6, 3), new Object[]
                {
                    "###", '#', Block.cobblestone
                });
        addRecipe(new ItemStack(Block.stoneSingleSlab, 6, 0), new Object[]
                {
                    "###", '#', Block.stone
                });
        addRecipe(new ItemStack(Block.stoneSingleSlab, 6, 1), new Object[]
                {
                    "###", '#', Block.sandStone
                });
        addRecipe(new ItemStack(Block.stoneSingleSlab, 6, 4), new Object[]
                {
                    "###", '#', Block.brick
                });
        addRecipe(new ItemStack(Block.stoneSingleSlab, 6, 5), new Object[]
                {
                    "###", '#', Block.stoneBrick
                });
