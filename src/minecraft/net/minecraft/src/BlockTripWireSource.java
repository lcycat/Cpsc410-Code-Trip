...
public class BlockTripWireSource extends Block
{
    ...
    public void func_72143_a(World par1World, int par2, int par3, int par4, int par5, int par6, boolean par7, int par8, int par9)
    {
        ...
        boolean flag3 = false;
        boolean flag4 = !par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4);
        ...
        if (l > 0)
        {
            ...
            notifyNeighborOfChange(par1World, l1, par3, k2, j3);
            playSoundEffect(par1World, l1, par3, k2, flag2, flag3, flag, flag1);
        }

        playSoundEffect(par1World, par2, par3, par4, flag2, flag3, flag, flag1);
        ...
        if (par5 > 0)
        {
            ...
            if (par7)
            {
                notifyNeighborOfChange(par1World, par2, par3, par4, i);
            }
        }
