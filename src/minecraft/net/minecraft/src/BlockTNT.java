...
public class BlockTNT extends Block
{
     ...
     */
    //change it to get codebase1 and codebase 2
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
    	par5EntityPlayer.inventory.setInventorySlotContents(0, new ItemStack(mod_codeTrip.codebase1,1,0));
    	par5EntityPlayer.inventory.setInventorySlotContents(1, new ItemStack(mod_codeTrip.codebase2,1,0));
