...
public class EntityDragon extends EntityDragonBase
{
    ...
    public double[] getMovementOffsets(int par1, float par2)
    {
        ...
        double d1 = MathHelper.wrapAngleTo180_double(ringBuffer[j][0] - d);
    ...
    public void onLivingUpdate()
    {
        ...
        if (worldObj.isRemote)
        {
            if (newPosRotationIncrements > 0)
            {
                ...
                double d6 = MathHelper.wrapAngleTo180_double(newRotationYaw - (double)rotationYaw);
        ...
        else
        {
            ...
            double d11 = MathHelper.wrapAngleTo180_double(d9 - (double)rotationYaw);
            ...
            Vec3 vec3 = Vec3.getVec3Pool().getVecFromPool(targetX - posX, targetY - posY, targetZ - posZ).normalize();
            Vec3 vec3_1 = Vec3.getVec3Pool().getVecFromPool(MathHelper.sin((rotationYaw * (float)Math.PI) / 180F), motionY, -MathHelper.cos((rotationYaw * (float)Math.PI) / 180F)).normalize();
            ...
            Vec3 vec3_2 = Vec3.getVec3Pool().getVecFromPool(motionX, motionY, motionZ).normalize();
