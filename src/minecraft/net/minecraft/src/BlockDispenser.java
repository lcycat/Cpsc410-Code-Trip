...
public class BlockDispenser extends BlockContainer
{
    ...
    private void dispenseItem(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        if (tileentitydispenser != null)
        {
            ...
            else
            {
                ...
                int i1 = spawnEntityWithAction(tileentitydispenser, par1World, itemstack, par5Random, par2, par3, par4, j, k, d, d1, d2);
                ...
                else if (i1 == 0)
                {
                    ...
                    dispenseEntityFromStack(par1World, itemstack1, par5Random, 6, j, k, d, d1, d2);
    ...
    private static int spawnEntityWithAction(TileEntityDispenser par0TileEntityDispenser, World par1World, ItemStack par2ItemStack, Random par3Random, int par4, int par5, int par6, int par7, int par8, double par9, double par11, double par13)
    {
        ...
        {
            par9 = (double)par4 + (par7 < 0 ? (double)par7 * 0.80000000000000004D : (float)par7 * 1.8F) + (double)((float)Math.abs(par8) * 0.5F);
            par13 = (double)par6 + (par8 < 0 ? (double)par8 * 0.80000000000000004D : (float)par8 * 1.8F) + (double)((float)Math.abs(par7) * 0.5F);
