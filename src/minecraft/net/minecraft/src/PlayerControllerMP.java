...
public class PlayerControllerMP
{
    ...
    public boolean onPlayerDestroyBlock(int par1, int par2, int par3, int par4)
    {
        ...
        if (!currentGameType.isCreative())
        {
            ...
            if (itemstack != null)
            {
                itemstack.func_77941_a(worldclient, block.blockID, par1, par2, par3, mc.thePlayer);
    ...
    public void clickBlock(int par1, int par2, int par3, int par4)
    {
        ...
        if (currentGameType.isCreative())
        {
            ...
            func_78744_a(mc, this, par1, par2, par3, par4);
            blockHitDelay = 5;
        }
        else if (!isHittingBlock || par1 != currentBlockX || par2 != currentBlockY || par3 != currentblockZ)
        {
            ...
            else
            {
                ...
                prevBlockDamageMP = 0.0F;
                stepSoundTickCounter = 0.0F;
                mc.theWorld.destroyBlockInWorldPartially(mc.thePlayer.entityId, currentBlockX, currentBlockY, currentblockZ, (int)(curBlockDamageMP * 10F) - 1);
            }
        }
    }
    ...
    public void onPlayerDamageBlock(int par1, int par2, int par3, int par4)
    {
        ...
        if (par1 == currentBlockX && par2 == currentBlockY && par3 == currentblockZ)
        {
            ...
            curBlockDamageMP += block.getPlayerRelativeBlockHardness(mc.thePlayer, mc.thePlayer.worldObj, par1, par2, par3);
