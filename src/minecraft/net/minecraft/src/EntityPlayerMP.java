...
public class EntityPlayerMP extends EntityPlayer implements ICrafting
{
    ...
    public void onUpdateEntity()
    {
        ...
        if (inPortal)
        {
            if (minecraftInstance.getAllowNether())
            {
                ...
                else
                {
                    ...
                    if (timeInPortal >= 1.0F)
                    {
                        ...
                        minecraftInstance.getConfigurationManager().transferPlayerToDimension(this, byte0);
                        lastExperience = -1;
                        lastHealth = -1;
                        lastFoodLevel = -1;
    ...
    {
        minecraftInstance.getConfigurationManager().sendPacketToAllPlayers(new Packet3Chat(par1DamageSource.func_76360_b(this)));
    ...
    public void travelToTheEnd(int par1)
    {
        ...
        else
        {
            ...
            minecraftInstance.getConfigurationManager().transferPlayerToDimension(this, 1);
            lastExperience = -1;
            lastHealth = -1;
            lastFoodLevel = -1;
        }
    ...
    public boolean canCommandSenderUseCommand(String par1Str)
    {
        ...
        {
            return minecraftInstance.getConfigurationManager().areCommandsAllowed(username);
        }
    }
    ...
    public void updateClientInfo(Packet204ClientInfo par1Packet204ClientInfo)
    {
        ...
        if (minecraftInstance.isSinglePlayer() && minecraftInstance.getServerOwner().equals(username))
        {
            minecraftInstance.setDifficultyForAllDimensions(par1Packet204ClientInfo.getDifficulty());
        }
    }
