...
public class EntityAIMoveThroughVillage extends EntityAIBase
{
    ...
    public boolean shouldExecute()
    {
        ...
        Vec3 vec3 = RandomPositionGenerator.findRandomTargetBlockTowards(theEntity, 10, 7, Vec3.getVec3Pool().getVecFromPool(doorInfo.posX, doorInfo.posY, doorInfo.posZ));
    ...
    {
        theEntity.getNavigator().setPath(field_75419_c, movementSpeed);
    }
