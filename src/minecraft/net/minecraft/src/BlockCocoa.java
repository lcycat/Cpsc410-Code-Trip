...
public class BlockCocoa extends BlockDirectional
{
    ...
    public boolean canBlockStay(World par1World, int par2, int par3, int par4)
    {
        ...
        return j == Block.wood.blockID && BlockLog.limitToValidMetadata(par1World.getBlockMetadata(par2, par3, par4)) == 3;
    }
     ...
     */
    public int getDamageValue(World par1World, int par2, int par3, int i)
    {
        return 3;
    }
}
