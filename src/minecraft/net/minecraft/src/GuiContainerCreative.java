...
public class GuiContainerCreative extends InventoryEffectRenderer
{
    ...
    protected void handleMouseClick(Slot par1Slot, int par2, int par3, boolean par4)
    {
        ...
        if (par1Slot != null)
        {
            ...
            {
                for (int i = 0; i < mc.thePlayer.inventorySlots.getInventory().size(); i++)
                {
    ...
    protected void drawGuiContainerForegroundLayer()
    {
        ...
        {
            fontRenderer.drawString(creativetabs.getTranslatedTabLabel(), 8, 6, 0x404040);
        }
    }
    ...
    {
        return field_74241_p != CreativeTabs.tabInventory.getTabIndex() && CreativeTabs.creativeTabArray[field_74241_p].shouldHidePlayerInventory() && ((ContainerCreative)inventorySlots).hasMoreThan1PageOfItemsInList();
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
    {
        ...
        CreativeTabs creativetabs = CreativeTabs.creativeTabArray[field_74241_p];
        int j = mc.renderEngine.getTexture((new StringBuilder()).append("/gui/creative_inv/").append(creativetabs.getBackgroundImageName()).toString());
        CreativeTabs acreativetabs[] = CreativeTabs.creativeTabArray;
    ...
    protected boolean func_74231_b(CreativeTabs par1CreativeTabs, int par2, int par3)
    {
        ...
        {
            func_74190_a(par1CreativeTabs.getTranslatedTabLabel(), par2, par3);
            return true;
        }
        else
        {
