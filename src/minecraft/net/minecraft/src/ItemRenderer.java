...
public class ItemRenderer
{
    ...
    public void renderItemInFirstPerson(float par1)
    {
        ...
        if (entityclientplayermp instanceof EntityPlayerSP)
        {
            ...
            float f2 = ((EntityPlayerSP)(entityclientplayermp1)).prevRenderArmPitch + (((EntityPlayerSP)(entityclientplayermp1)).renderArmPitch - ((EntityPlayerSP)(entityclientplayermp1)).prevRenderArmPitch) * par1;
            float f4 = ((EntityPlayerSP)(entityclientplayermp1)).prevRenderArmYaw + (((EntityPlayerSP)(entityclientplayermp1)).renderArmYaw - ((EntityPlayerSP)(entityclientplayermp1)).prevRenderArmYaw) * par1;
        ...
        if (itemstack != null)
        {
            int l = Item.itemsList[itemstack.itemID].getColorFromDamage(itemstack.getItemDamage(), 0);
        ...
        else if (itemstack != null)
        {
            ...
            if (entityclientplayermp.getItemInUseCount() > 0)
            {
                ...
                if (enumaction == EnumAction.eat || enumaction == EnumAction.drink)
                {
                    ...
                    f26 = f26 * f26 * f26;
                    float f29 = 1.0F - f26;
                    GL11.glTranslatef(0.0F, MathHelper.abs(MathHelper.cos((f15 / 4F) * (float)Math.PI) * 0.1F) * (float)((double)f21 > 0.20000000000000001D ? 1 : 0), 0.0F);
