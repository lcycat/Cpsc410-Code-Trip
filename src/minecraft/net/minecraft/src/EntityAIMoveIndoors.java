...
public class EntityAIMoveIndoors extends EntityAIBase
{
    ...
    public void startExecuting()
    {
        ...
        {
            Vec3 vec3 = RandomPositionGenerator.findRandomTargetBlockTowards(entityObj, 14, 3, Vec3.getVec3Pool().getVecFromPool((double)doorInfo.getInsidePosX() + 0.5D, doorInfo.getInsidePosY(), (double)doorInfo.getInsidePosZ() + 0.5D));
