...
public class RConThreadMain extends RConThreadBase
{
    ...
    public RConThreadMain(IServer par1IServer)
    {
        super(par1IServer);
        field_72649_j = null;
        field_72647_g = par1IServer.getOrSetIntProperty("rcon.port", 0);
        field_72650_k = par1IServer.getOrSetProperty("rcon.password", "");
        field_72652_i = par1IServer.getHostName();
        field_72651_h = par1IServer.getMyServerPort();
        ...
        if (0 == field_72647_g)
        {
            ...
            par1IServer.setArbitraryProperty("rcon.port", Integer.valueOf(field_72647_g));
    ...
    public void func_72602_a()
    {
        if (0 == field_72650_k.length())
        {
            func_72606_c((new StringBuilder()).append("No rcon password set in '").append(field_72617_b.getSettingsFilePath()).append("', rcon disabled!").toString());
            return;
        }

        if (0 >= field_72647_g || 65535 < field_72647_g)
        {
            func_72606_c((new StringBuilder()).append("Invalid rcon port ").append(field_72647_g).append(" found in '").append(field_72617_b.getSettingsFilePath()).append("', rcon disabled!").toString());
            return;
        }
