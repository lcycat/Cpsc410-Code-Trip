...
class CallableMPL1 implements Callable
{
    ...
    {
        return (new StringBuilder()).append(WorldClient.getEntityList(worldClientMPL1).size()).append(" total; ").append(WorldClient.getEntityList(worldClientMPL1).toString()).toString();
    }
