...
public class WorldManager implements IWorldAccess
{
    ...
    {
        field_72782_b.getEntityTracker().addEntityToTracker(par1Entity);
    }
    ...
    {
        field_72782_b.getEntityTracker().removeEntityFromAllTrackingPlayers(par1Entity);
    }
    ...
    {
        mcServer.getConfigurationManager().sendToAllNear(par2, par4, par6, par8 <= 1.0F ? 16D : 16F * par8, field_72782_b.provider.worldType, new Packet62LevelSound(par1Str, par2, par4, par6, par8, par9));
    }
    ...
    {
        field_72782_b.getPlayerManager().flagChunkForUpdate(par1, par2, par3);
    }
    ...
    {
        mcServer.getConfigurationManager().sendToAllNearExcept(par1EntityPlayer, par3, par4, par5, 64D, field_72782_b.provider.worldType, new Packet61DoorChange(par2, par3, par4, par5, par6));
    }
    ...
    {
        Iterator iterator = mcServer.getConfigurationManager().playerList.iterator();
