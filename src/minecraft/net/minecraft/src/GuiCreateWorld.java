...
public class GuiCreateWorld extends GuiScreen
{
    ...
    //-----------------------------------------------------------------------------
    //public static codebase1Block codebase1;
	//public static codebase2Block codebase2;
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        ...
        else if (par1GuiButton.id == 0)
        {
            ...
            //changed gamemod to "creative"
            EnumGameType enumgametype = EnumGameType.getByName("creative");
